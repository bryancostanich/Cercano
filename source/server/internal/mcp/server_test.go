...
func (m *mockAgentClient) ListSubAgents(ctx context.Context, in *proto.ListSubAgentsRequest, opts ...grpc.CallOption) (*proto.ListSubAgentsResponse, error) {
...
func (m *mockAgentClient) GetTokenMetrics(ctx context.Context, in *proto.GetTokenMetricsRequest, opts ...grpc.CallOption) (*proto.GetTokenMetricsResponse, error) {
	return &proto.GetTokenMetricsResponse{}, nil
}
...
func (m *mockAgentClient) GetCloudProviders(ctx context.Context, in *proto.GetCloudProvidersRequest, opts ...grpc.CallOption) (*proto.GetCloudProvidersResponse, error) {
