...
const file_agent_proto_rawDesc = "" +
	...
	"\n" +
	"TokenDelta\x12\x18\n" +
	"\acontent\x18\x01 \x01(\tR\acontent\"\xa6\x06\n" +
	...
	"\x10rollover_offered\x18\f \x01(\v2\x16.agent.RolloverOfferedH\x00R\x0frolloverOfferedB\t\n" +
	"\apayload\"\xe1\x01\n" +
...
var file_agent_proto_msgTypes = make([]protoimpl.MessageInfo, 186)
var file_agent_proto_goTypes = []any{
	...
	(*RolloverOffered)(nil),                    // 4: agent.RolloverOffered
	(*RouteSelected)(nil),                      // 5: agent.RouteSelected
	(*WatchdogEvent)(nil),                      // 6: agent.WatchdogEvent
	(*ProgressUpdate)(nil),                     // 7: agent.ProgressUpdate
	(*SubAgentEvent)(nil),                      // 8: agent.SubAgentEvent
	(*ProcessRequestRequest)(nil),              // 9: agent.ProcessRequestRequest
	(*InlineImage)(nil),                        // 10: agent.InlineImage
	(*UpdateConfigRequest)(nil),                // 11: agent.UpdateConfigRequest
	(*UpdateConfigResponse)(nil),               // 12: agent.UpdateConfigResponse
	(*ProcessRequestResponse)(nil),             // 13: agent.ProcessRequestResponse
	(*FileChange)(nil),                         // 14: agent.FileChange
	(*RoutingMetadata)(nil),                    // 15: agent.RoutingMetadata
	(*ListModelsRequest)(nil),                  // 16: agent.ListModelsRequest
	(*ModelInfo)(nil),                          // 17: agent.ModelInfo
	(*ListModelsResponse)(nil),                 // 18: agent.ListModelsResponse
	(*RuntimeModel)(nil),                       // 19: agent.RuntimeModel
	(*RuntimeInstance)(nil),                    // 20: agent.RuntimeInstance
	(*RuntimeEndpoint)(nil),                    // 21: agent.RuntimeEndpoint
	(*RuntimeLogEntry)(nil),                    // 22: agent.RuntimeLogEntry
	(*GetRuntimeStatusRequest)(nil),            // 23: agent.GetRuntimeStatusRequest
	(*GetRuntimeStatusResponse)(nil),           // 24: agent.GetRuntimeStatusResponse
	(*ListRuntimeModelsRequest)(nil),           // 25: agent.ListRuntimeModelsRequest
	(*ListRuntimeModelsResponse)(nil),          // 26: agent.ListRuntimeModelsResponse
	(*GetModelRAMEstimateRequest)(nil),         // 27: agent.GetModelRAMEstimateRequest
	(*GetModelRAMEstimateResponse)(nil),        // 28: agent.GetModelRAMEstimateResponse
	(*RefreshOnlineCatalogRequest)(nil),        // 29: agent.RefreshOnlineCatalogRequest
	(*RefreshOnlineCatalogResponse)(nil),       // 30: agent.RefreshOnlineCatalogResponse
	(*ListRuntimeEndpointsRequest)(nil),        // 31: agent.ListRuntimeEndpointsRequest
	(*ListRuntimeEndpointsResponse)(nil),       // 32: agent.ListRuntimeEndpointsResponse
	(*StartRuntimeModelRequest)(nil),           // 33: agent.StartRuntimeModelRequest
	(*StartRuntimeModelResponse)(nil),          // 34: agent.StartRuntimeModelResponse
	(*StopRuntimeModelRequest)(nil),            // 35: agent.StopRuntimeModelRequest
	(*StopRuntimeModelResponse)(nil),           // 36: agent.StopRuntimeModelResponse
	(*RestartRuntimeRequest)(nil),              // 37: agent.RestartRuntimeRequest
	(*RestartRuntimeResponse)(nil),             // 38: agent.RestartRuntimeResponse
	(*DownloadRuntimeModelRequest)(nil),        // 39: agent.DownloadRuntimeModelRequest
	(*DownloadRuntimeModelResponse)(nil),       // 40: agent.DownloadRuntimeModelResponse
	(*CancelRuntimeModelDownloadRequest)(nil),  // 41: agent.CancelRuntimeModelDownloadRequest
	(*CancelRuntimeModelDownloadResponse)(nil), // 42: agent.CancelRuntimeModelDownloadResponse
	(*DeleteRuntimeModelRequest)(nil),          // 43: agent.DeleteRuntimeModelRequest
	(*DeleteRuntimeModelResponse)(nil),         // 44: agent.DeleteRuntimeModelResponse
	(*StreamRuntimeLogsRequest)(nil),           // 45: agent.StreamRuntimeLogsRequest
	(*Conversation)(nil),                       // 46: agent.Conversation
	(*PersistedTurn)(nil),                      // 47: agent.PersistedTurn
	(*ListConversationsRequest)(nil),           // 48: agent.ListConversationsRequest
	(*ListConversationsResponse)(nil),          // 49: agent.ListConversationsResponse
	(*ResumeConversationRequest)(nil),          // 50: agent.ResumeConversationRequest
	(*ResumeConversationResponse)(nil),         // 51: agent.ResumeConversationResponse
	(*DeleteConversationRequest)(nil),          // 52: agent.DeleteConversationRequest
	(*DeleteConversationResponse)(nil),         // 53: agent.DeleteConversationResponse
	(*RenameConversationRequest)(nil),          // 54: agent.RenameConversationRequest
	(*RenameConversationResponse)(nil),         // 55: agent.RenameConversationResponse
	(*GetConversationRequest)(nil),             // 56: agent.GetConversationRequest
	(*ListSubAgentsRequest)(nil),               // 57: agent.ListSubAgentsRequest
	(*ListSubAgentsResponse)(nil),              // 58: agent.ListSubAgentsResponse
	(*DismissSubAgentRequest)(nil),             // 59: agent.DismissSubAgentRequest
	(*DismissSubAgentResponse)(nil),            // 60: agent.DismissSubAgentResponse
	(*SubAgentConversation)(nil),               // 61: agent.SubAgentConversation
	(*GetContextUsageRequest)(nil),             // 62: agent.GetContextUsageRequest
	(*GetContextUsageResponse)(nil),            // 63: agent.GetContextUsageResponse
	(*SuggestNextPromptRequest)(nil),           // 64: agent.SuggestNextPromptRequest
	(*SuggestNextPromptResponse)(nil),          // 65: agent.SuggestNextPromptResponse
	(*GetCompactionStateRequest)(nil),          // 66: agent.GetCompactionStateRequest
	(*GetCompactionStateResponse)(nil),         // 67: agent.GetCompactionStateResponse
	(*ElideContextRequest)(nil),                // 68: agent.ElideContextRequest
	(*ElideContextResponse)(nil),               // 69: agent.ElideContextResponse
	(*ExportContextRequest)(nil),               // 70: agent.ExportContextRequest
	(*ExportContextResponse)(nil),              // 71: agent.ExportContextResponse
	(*ExportTrajectoryRequest)(nil),            // 72: agent.ExportTrajectoryRequest
	(*ExportTrajectoryProgress)(nil),           // 73: agent.ExportTrajectoryProgress
	(*ExportTrajectoryWarning)(nil),            // 74: agent.ExportTrajectoryWarning
	(*ExportTrajectoryCompleted)(nil),          // 75: agent.ExportTrajectoryCompleted
	(*ExportTrajectoryFailed)(nil),             // 76: agent.ExportTrajectoryFailed
	(*ExportTrajectoryEvent)(nil),              // 77: agent.ExportTrajectoryEvent
	(*GetConversationTurnsRequest)(nil),        // 78: agent.GetConversationTurnsRequest
	(*GetConversationTurnsResponse)(nil),       // 79: agent.GetConversationTurnsResponse
	(*GetToolCallRequest)(nil),                 // 80: agent.GetToolCallRequest
	(*GetToolCallResponse)(nil),                // 81: agent.GetToolCallResponse
	(*ContextTurn)(nil),                        // 82: agent.ContextTurn
	(*ProposeContextEditRequest)(nil),          // 83: agent.ProposeContextEditRequest
	(*ProposeContextEditResponse)(nil),         // 84: agent.ProposeContextEditResponse
	(*DeleteConversationTurnsRequest)(nil),     // 85: agent.DeleteConversationTurnsRequest
	(*DeleteConversationTurnsResponse)(nil),    // 86: agent.DeleteConversationTurnsResponse
	(*BuiltinTool)(nil),                        // 87: agent.BuiltinTool
	(*ListToolsRequest)(nil),                   // 88: agent.ListToolsRequest
	(*ListToolsResponse)(nil),                  // 89: agent.ListToolsResponse
	(*InvokeToolRequest)(nil),                  // 90: agent.InvokeToolRequest
	(*InvokeToolResponse)(nil),                 // 91: agent.InvokeToolResponse
	(*InvokeCapabilityRequest)(nil),            // 92: agent.InvokeCapabilityRequest
	(*InvokeCapabilityResponse)(nil),           // 93: agent.InvokeCapabilityResponse
	(*GetConfigRequest)(nil),                   // 94: agent.GetConfigRequest
	(*GetConfigResponse)(nil),                  // 95: agent.GetConfigResponse
	(*ListSkillsRequest)(nil),                  // 96: agent.ListSkillsRequest
	(*SkillInfo)(nil),                          // 97: agent.SkillInfo
	(*ListSkillsResponse)(nil),                 // 98: agent.ListSkillsResponse
	(*GetSkillRequest)(nil),                    // 99: agent.GetSkillRequest
	(*GetSkillResponse)(nil),                   // 100: agent.GetSkillResponse
	(*SetPermissionModeRequest)(nil),           // 101: agent.SetPermissionModeRequest
	(*SetPermissionModeResponse)(nil),          // 102: agent.SetPermissionModeResponse
	(*GetPermissionModeRequest)(nil),           // 103: agent.GetPermissionModeRequest
	(*GetPermissionModeResponse)(nil),          // 104: agent.GetPermissionModeResponse
	(*SubscribeEventsRequest)(nil),             // 105: agent.SubscribeEventsRequest
	(*ClientEvent)(nil),                        // 106: agent.ClientEvent
	(*PermissionModeChanged)(nil),              // 107: agent.PermissionModeChanged
	(*ConfigChanged)(nil),                      // 108: agent.ConfigChanged
	(*OpenRuntimeStatus)(nil),                  // 109: agent.OpenRuntimeStatus
	(*OpenRuntimeStatusChanged)(nil),           // 110: agent.OpenRuntimeStatusChanged
	(*GetOpenRuntimeStatusRequest)(nil),        // 111: agent.GetOpenRuntimeStatusRequest
	(*GetOpenRuntimeStatusResponse)(nil),       // 112: agent.GetOpenRuntimeStatusResponse
	(*InstallOpenRuntimeRequest)(nil),          // 113: agent.InstallOpenRuntimeRequest
	(*InstallProgress)(nil),                    // 114: agent.InstallProgress
	(*RegenerateContextRequest)(nil),           // 115: agent.RegenerateContextRequest
	(*RegenerateContextProgress)(nil),          // 116: agent.RegenerateContextProgress
	(*AllowToolCallRequest)(nil),               // 117: agent.AllowToolCallRequest
	(*AllowToolCallResponse)(nil),              // 118: agent.AllowToolCallResponse
	(*DenyToolCallRequest)(nil),                // 119: agent.DenyToolCallRequest
	(*DenyToolCallResponse)(nil),               // 120: agent.DenyToolCallResponse
	(*AcceptRolloverRequest)(nil),              // 121: agent.AcceptRolloverRequest
	(*AcceptRolloverResponse)(nil),             // 122: agent.AcceptRolloverResponse
	(*DeclineRolloverRequest)(nil),             // 123: agent.DeclineRolloverRequest
	(*DeclineRolloverResponse)(nil),            // 124: agent.DeclineRolloverResponse
	(*GetProviderCapabilitiesRequest)(nil),     // 125: agent.GetProviderCapabilitiesRequest
	(*GetProviderCapabilitiesResponse)(nil),    // 126: agent.GetProviderCapabilitiesResponse
	(*ToolUseStart)(nil),                       // 127: agent.ToolUseStart
	(*ToolUseStop)(nil),                        // 128: agent.ToolUseStop
	(*ToolExecStart)(nil),                      // 129: agent.ToolExecStart
	(*ToolExecComplete)(nil),                   // 130: agent.ToolExecComplete
	(*PermissionRequired)(nil),                 // 131: agent.PermissionRequired
	(*McpServerInfo)(nil),                      // 132: agent.McpServerInfo
	(*ListMcpServersRequest)(nil),              // 133: agent.ListMcpServersRequest
	(*ListMcpServersResponse)(nil),             // 134: agent.ListMcpServersResponse
	(*AddMcpServerRequest)(nil),                // 135: agent.AddMcpServerRequest
	(*AddMcpServerResponse)(nil),               // 136: agent.AddMcpServerResponse
	(*RemoveMcpServerRequest)(nil),             // 137: agent.RemoveMcpServerRequest
	(*RemoveMcpServerResponse)(nil),            // 138: agent.RemoveMcpServerResponse
	(*RestartMcpServerRequest)(nil),            // 139: agent.RestartMcpServerRequest
	(*RestartMcpServerResponse)(nil),           // 140: agent.RestartMcpServerResponse
	(*CloudProfileInfo)(nil),                   // 141: agent.CloudProfileInfo
	(*GetCloudProfilesRequest)(nil),            // 142: agent.GetCloudProfilesRequest
	(*GetCloudProfilesResponse)(nil),           // 143: agent.GetCloudProfilesResponse
	(*CloudProvider)(nil),                      // 144: agent.CloudProvider
	(*GetCloudProvidersRequest)(nil),           // 145: agent.GetCloudProvidersRequest
	(*GetCloudProvidersResponse)(nil),          // 146: agent.GetCloudProvidersResponse
	(*SetActiveCloudProfileRequest)(nil),       // 147: agent.SetActiveCloudProfileRequest
	(*SetActiveCloudProfileResponse)(nil),      // 148: agent.SetActiveCloudProfileResponse
	(*SetBackupCloudProfileRequest)(nil),       // 149: agent.SetBackupCloudProfileRequest
	(*SetBackupCloudProfileResponse)(nil),      // 150: agent.SetBackupCloudProfileResponse
	(*SetCloudProfileKeyRequest)(nil),          // 151: agent.SetCloudProfileKeyRequest
	(*SetCloudProfileKeyResponse)(nil),         // 152: agent.SetCloudProfileKeyResponse
	(*UpsertCloudProfileRequest)(nil),          // 153: agent.UpsertCloudProfileRequest
	(*UpsertCloudProfileResponse)(nil),         // 154: agent.UpsertCloudProfileResponse
	(*RemoveCloudProfileRequest)(nil),          // 155: agent.RemoveCloudProfileRequest
	(*RemoveCloudProfileResponse)(nil),         // 156: agent.RemoveCloudProfileResponse
	(*CloudModelInfo)(nil),                     // 157: agent.CloudModelInfo
	(*ListCloudProfileModelsRequest)(nil),      // 158: agent.ListCloudProfileModelsRequest
	(*ListCloudProfileModelsResponse)(nil),     // 159: agent.ListCloudProfileModelsResponse
	(*StartChatGPTLoginRequest)(nil),           // 160: agent.StartChatGPTLoginRequest
	(*StartChatGPTLoginEvent)(nil),             // 161: agent.StartChatGPTLoginEvent
	(*StartClaudeLoginRequest)(nil),            // 162: agent.StartClaudeLoginRequest
	(*StartClaudeLoginEvent)(nil),              // 163: agent.StartClaudeLoginEvent
	(*AttachConversationRequest)(nil),          // 164: agent.AttachConversationRequest
	(*HostToWorker)(nil),                       // 165: agent.HostToWorker
	(*WorkerToHost)(nil),                       // 166: agent.WorkerToHost
	(*StartTurn)(nil),                          // 167: agent.StartTurn
	(*LLMMessage)(nil),                         // 168: agent.LLMMessage
	(*WorkerEvent)(nil),                        // 169: agent.WorkerEvent
	(*PermissionRequest)(nil),                  // 170: agent.PermissionRequest
	(*PermissionResponse)(nil),                 // 171: agent.PermissionResponse
	(*PersistTurn)(nil),                        // 172: agent.PersistTurn
	(*EnsureSubagentConversation)(nil),         // 173: agent.EnsureSubagentConversation
	(*TurnDone)(nil),                           // 174: agent.TurnDone
	(*TurnError)(nil),                          // 175: agent.TurnError
	(*Cancel)(nil),                             // 176: agent.Cancel
	(*ConfigSnapshot)(nil),                     // 177: agent.ConfigSnapshot
	(*CredentialRequest)(nil),                  // 178: agent.CredentialRequest
	(*CredentialResponse)(nil),                 // 179: agent.CredentialResponse
	(*OpenInferenceRequest)(nil),               // 180: agent.OpenInferenceRequest
	(*LLMChatRequest)(nil),                     // 181: agent.LLMChatRequest
	(*LLMTool)(nil),                            // 182: agent.LLMTool
	(*OpenInferenceEvent)(nil),                 // 183: agent.OpenInferenceEvent
	(*LLMStreamEvent)(nil),                     // 184: agent.LLMStreamEvent
	nil,                                        // 185: agent.ListRuntimeModelsResponse.RecommendedOpenModelsEntry
	nil,                                        // 186: agent.GetConfigResponse.ModelTiersEntry
	nil,                                        // 187: agent.AddMcpServerRequest.EnvEntry
}
var file_agent_proto_depIdxs = []int32{
	7,   // 0: agent.StreamProcessResponse.progress:type_name -> agent.ProgressUpdate
	13,  // 1: agent.StreamProcessResponse.final_response:type_name -> agent.ProcessRequestResponse
	2,   // 2: agent.StreamProcessResponse.token_delta:type_name -> agent.TokenDelta
	127, // 3: agent.StreamProcessResponse.tool_use_start:type_name -> agent.ToolUseStart
	128, // 4: agent.StreamProcessResponse.tool_use_stop:type_name -> agent.ToolUseStop
	129, // 5: agent.StreamProcessResponse.tool_exec_start:type_name -> agent.ToolExecStart
	130, // 6: agent.StreamProcessResponse.tool_exec_complete:type_name -> agent.ToolExecComplete
	131, // 7: agent.StreamProcessResponse.permission_required:type_name -> agent.PermissionRequired
	5,   // 8: agent.StreamProcessResponse.route_selected:type_name -> agent.RouteSelected
	6,   // 9: agent.StreamProcessResponse.watchdog_event:type_name -> agent.WatchdogEvent
	8,   // 10: agent.StreamProcessResponse.sub_agent_event:type_name -> agent.SubAgentEvent
	4,   // 11: agent.StreamProcessResponse.rollover_offered:type_name -> agent.RolloverOffered
	10,  // 12: agent.ProcessRequestRequest.images:type_name -> agent.InlineImage
	14,  // 13: agent.ProcessRequestResponse.file_changes:type_name -> agent.FileChange
	15,  // 14: agent.ProcessRequestResponse.routing_metadata:type_name -> agent.RoutingMetadata
	0,   // 15: agent.FileChange.action:type_name -> agent.FileAction
	17,  // 16: agent.ListModelsResponse.models:type_name -> agent.ModelInfo
	19,  // 17: agent.GetRuntimeStatusResponse.models:type_name -> agent.RuntimeModel
	20,  // 18: agent.GetRuntimeStatusResponse.instances:type_name -> agent.RuntimeInstance
	21,  // 19: agent.GetRuntimeStatusResponse.endpoints:type_name -> agent.RuntimeEndpoint
	22,  // 20: agent.GetRuntimeStatusResponse.logs:type_name -> agent.RuntimeLogEntry
	19,  // 21: agent.ListRuntimeModelsResponse.models:type_name -> agent.RuntimeModel
	185, // 22: agent.ListRuntimeModelsResponse.recommended_open_models:type_name -> agent.ListRuntimeModelsResponse.RecommendedOpenModelsEntry
	21,  // 23: agent.ListRuntimeEndpointsResponse.endpoints:type_name -> agent.RuntimeEndpoint
	20,  // 24: agent.StartRuntimeModelResponse.instance:type_name -> agent.RuntimeInstance
	20,  // 25: agent.RestartRuntimeResponse.instance:type_name -> agent.RuntimeInstance
	19,  // 26: agent.DownloadRuntimeModelResponse.model:type_name -> agent.RuntimeModel
	19,  // 27: agent.CancelRuntimeModelDownloadResponse.model:type_name -> agent.RuntimeModel
	46,  // 28: agent.ListConversationsResponse.conversations:type_name -> agent.Conversation
	47,  // 29: agent.ResumeConversationResponse.turns:type_name -> agent.PersistedTurn
	61,  // 30: agent.ListSubAgentsResponse.subagents:type_name -> agent.SubAgentConversation
	73,  // 31: agent.ExportTrajectoryEvent.progress:type_name -> agent.ExportTrajectoryProgress
	74,  // 32: agent.ExportTrajectoryEvent.warning:type_name -> agent.ExportTrajectoryWarning
	75,  // 33: agent.ExportTrajectoryEvent.completed:type_name -> agent.ExportTrajectoryCompleted
	76,  // 34: agent.ExportTrajectoryEvent.failed:type_name -> agent.ExportTrajectoryFailed
	82,  // 35: agent.GetConversationTurnsResponse.turns:type_name -> agent.ContextTurn
	87,  // 36: agent.ListToolsResponse.tools:type_name -> agent.BuiltinTool
	186, // 37: agent.GetConfigResponse.model_tiers:type_name -> agent.GetConfigResponse.ModelTiersEntry
	97,  // 38: agent.ListSkillsResponse.skills:type_name -> agent.SkillInfo
	107, // 39: agent.ClientEvent.permission_mode_changed:type_name -> agent.PermissionModeChanged
	108, // 40: agent.ClientEvent.config_changed:type_name -> agent.ConfigChanged
	110, // 41: agent.ClientEvent.open_runtime_status_changed:type_name -> agent.OpenRuntimeStatusChanged
	109, // 42: agent.OpenRuntimeStatusChanged.status:type_name -> agent.OpenRuntimeStatus
	109, // 43: agent.GetOpenRuntimeStatusResponse.status:type_name -> agent.OpenRuntimeStatus
	132, // 44: agent.ListMcpServersResponse.servers:type_name -> agent.McpServerInfo
	187, // 45: agent.AddMcpServerRequest.env:type_name -> agent.AddMcpServerRequest.EnvEntry
	141, // 46: agent.GetCloudProfilesResponse.profiles:type_name -> agent.CloudProfileInfo
	141, // 47: agent.CloudProvider.profiles:type_name -> agent.CloudProfileInfo
	144, // 48: agent.GetCloudProvidersResponse.providers:type_name -> agent.CloudProvider
	141, // 49: agent.GetCloudProvidersResponse.custom_profiles:type_name -> agent.CloudProfileInfo
	157, // 50: agent.ListCloudProfileModelsResponse.models:type_name -> agent.CloudModelInfo
	167, // 51: agent.HostToWorker.start:type_name -> agent.StartTurn
	171, // 52: agent.HostToWorker.perm_response:type_name -> agent.PermissionResponse
	176, // 53: agent.HostToWorker.cancel:type_name -> agent.Cancel
	179, // 54: agent.HostToWorker.cred_response:type_name -> agent.CredentialResponse
	183, // 55: agent.HostToWorker.open_event:type_name -> agent.OpenInferenceEvent
	169, // 56: agent.WorkerToHost.event:type_name -> agent.WorkerEvent
	170, // 57: agent.WorkerToHost.perm_request:type_name -> agent.PermissionRequest
	172, // 58: agent.WorkerToHost.persist:type_name -> agent.PersistTurn
	174, // 59: agent.WorkerToHost.done:type_name -> agent.TurnDone
	175, // 60: agent.WorkerToHost.error:type_name -> agent.TurnError
	178, // 61: agent.WorkerToHost.cred_request:type_name -> agent.CredentialRequest
	173, // 62: agent.WorkerToHost.ensure_subagent:type_name -> agent.EnsureSubagentConversation
	180, // 63: agent.WorkerToHost.open_request:type_name -> agent.OpenInferenceRequest
	10,  // 64: agent.StartTurn.images:type_name -> agent.InlineImage
	177, // 65: agent.StartTurn.config:type_name -> agent.ConfigSnapshot
	168, // 66: agent.StartTurn.history:type_name -> agent.LLMMessage
	1,   // 67: agent.WorkerEvent.kind:type_name -> agent.WorkerEventKind
	168, // 68: agent.PersistTurn.message:type_name -> agent.LLMMessage
	181, // 69: agent.OpenInferenceRequest.request:type_name -> agent.LLMChatRequest
	168, // 70: agent.LLMChatRequest.messages:type_name -> agent.LLMMessage
	182, // 71: agent.LLMChatRequest.tools:type_name -> agent.LLMTool
	184, // 72: agent.OpenInferenceEvent.event:type_name -> agent.LLMStreamEvent
	9,   // 73: agent.Agent.ProcessRequest:input_type -> agent.ProcessRequestRequest
	9,   // 74: agent.Agent.StreamProcessRequest:input_type -> agent.ProcessRequestRequest
	164, // 75: agent.Agent.AttachConversation:input_type -> agent.AttachConversationRequest
	11,  // 76: agent.Agent.UpdateConfig:input_type -> agent.UpdateConfigRequest
	94,  // 77: agent.Agent.GetConfig:input_type -> agent.GetConfigRequest
	48,  // 78: agent.Agent.ListConversations:input_type -> agent.ListConversationsRequest
	50,  // 79: agent.Agent.ResumeConversation:input_type -> agent.ResumeConversationRequest
	52,  // 80: agent.Agent.DeleteConversation:input_type -> agent.DeleteConversationRequest
	54,  // 81: agent.Agent.RenameConversation:input_type -> agent.RenameConversationRequest
	56,  // 82: agent.Agent.GetConversation:input_type -> agent.GetConversationRequest
	57,  // 83: agent.Agent.ListSubAgents:input_type -> agent.ListSubAgentsRequest
	59,  // 84: agent.Agent.DismissSubAgent:input_type -> agent.DismissSubAgentRequest
	62,  // 85: agent.Agent.GetContextUsage:input_type -> agent.GetContextUsageRequest
	66,  // 86: agent.Agent.GetCompactionState:input_type -> agent.GetCompactionStateRequest
	68,  // 87: agent.Agent.ElideContext:input_type -> agent.ElideContextRequest
	64,  // 88: agent.Agent.SuggestNextPrompt:input_type -> agent.SuggestNextPromptRequest
	111, // 89: agent.Agent.GetOpenRuntimeStatus:input_type -> agent.GetOpenRuntimeStatusRequest
	113, // 90: agent.Agent.InstallOpenRuntime:input_type -> agent.InstallOpenRuntimeRequest
	115, // 91: agent.Agent.RegenerateContext:input_type -> agent.RegenerateContextRequest
	70,  // 92: agent.Agent.ExportContext:input_type -> agent.ExportContextRequest
	72,  // 93: agent.Agent.ExportTrajectory:input_type -> agent.ExportTrajectoryRequest
	78,  // 94: agent.Agent.GetConversationTurns:input_type -> agent.GetConversationTurnsRequest
	80,  // 95: agent.Agent.GetToolCall:input_type -> agent.GetToolCallRequest
	88,  // 96: agent.Agent.ListTools:input_type -> agent.ListToolsRequest
	90,  // 97: agent.Agent.InvokeTool:input_type -> agent.InvokeToolRequest
	92,  // 98: agent.Agent.InvokeCapability:input_type -> agent.InvokeCapabilityRequest
	16,  // 99: agent.Agent.ListModels:input_type -> agent.ListModelsRequest
	23,  // 100: agent.Agent.GetRuntimeStatus:input_type -> agent.GetRuntimeStatusRequest
	25,  // 101: agent.Agent.ListRuntimeModels:input_type -> agent.ListRuntimeModelsRequest
	31,  // 102: agent.Agent.ListRuntimeEndpoints:input_type -> agent.ListRuntimeEndpointsRequest
	33,  // 103: agent.Agent.StartRuntimeModel:input_type -> agent.StartRuntimeModelRequest
	35,  // 104: agent.Agent.StopRuntimeModel:input_type -> agent.StopRuntimeModelRequest
	37,  // 105: agent.Agent.RestartRuntime:input_type -> agent.RestartRuntimeRequest
	39,  // 106: agent.Agent.DownloadRuntimeModel:input_type -> agent.DownloadRuntimeModelRequest
	41,  // 107: agent.Agent.CancelRuntimeModelDownload:input_type -> agent.CancelRuntimeModelDownloadRequest
	43,  // 108: agent.Agent.DeleteRuntimeModel:input_type -> agent.DeleteRuntimeModelRequest
	29,  // 109: agent.Agent.RefreshOnlineCatalog:input_type -> agent.RefreshOnlineCatalogRequest
	27,  // 110: agent.Agent.GetModelRAMEstimate:input_type -> agent.GetModelRAMEstimateRequest
	45,  // 111: agent.Agent.StreamRuntimeLogs:input_type -> agent.StreamRuntimeLogsRequest
	96,  // 112: agent.Agent.ListSkills:input_type -> agent.ListSkillsRequest
	99,  // 113: agent.Agent.GetSkill:input_type -> agent.GetSkillRequest
	101, // 114: agent.Agent.SetPermissionMode:input_type -> agent.SetPermissionModeRequest
	103, // 115: agent.Agent.GetPermissionMode:input_type -> agent.GetPermissionModeRequest
	105, // 116: agent.Agent.SubscribeEvents:input_type -> agent.SubscribeEventsRequest
	117, // 117: agent.Agent.AllowToolCall:input_type -> agent.AllowToolCallRequest
	119, // 118: agent.Agent.DenyToolCall:input_type -> agent.DenyToolCallRequest
	121, // 119: agent.Agent.AcceptRollover:input_type -> agent.AcceptRolloverRequest
	123, // 120: agent.Agent.DeclineRollover:input_type -> agent.DeclineRolloverRequest
	125, // 121: agent.Agent.GetProviderCapabilities:input_type -> agent.GetProviderCapabilitiesRequest
	83,  // 122: agent.Agent.ProposeContextEdit:input_type -> agent.ProposeContextEditRequest
	85,  // 123: agent.Agent.DeleteConversationTurns:input_type -> agent.DeleteConversationTurnsRequest
	133, // 124: agent.Agent.ListMcpServers:input_type -> agent.ListMcpServersRequest
	135, // 125: agent.Agent.AddMcpServer:input_type -> agent.AddMcpServerRequest
	137, // 126: agent.Agent.RemoveMcpServer:input_type -> agent.RemoveMcpServerRequest
	139, // 127: agent.Agent.RestartMcpServer:input_type -> agent.RestartMcpServerRequest
	142, // 128: agent.Agent.GetCloudProfiles:input_type -> agent.GetCloudProfilesRequest
	145, // 129: agent.Agent.GetCloudProviders:input_type -> agent.GetCloudProvidersRequest
	147, // 130: agent.Agent.SetActiveCloudProfile:input_type -> agent.SetActiveCloudProfileRequest
	149, // 131: agent.Agent.SetBackupCloudProfile:input_type -> agent.SetBackupCloudProfileRequest
	151, // 132: agent.Agent.SetCloudProfileKey:input_type -> agent.SetCloudProfileKeyRequest
	153, // 133: agent.Agent.UpsertCloudProfile:input_type -> agent.UpsertCloudProfileRequest
	155, // 134: agent.Agent.RemoveCloudProfile:input_type -> agent.RemoveCloudProfileRequest
	158, // 135: agent.Agent.ListCloudProfileModels:input_type -> agent.ListCloudProfileModelsRequest
	160, // 136: agent.Agent.StartChatGPTLogin:input_type -> agent.StartChatGPTLoginRequest
	162, // 137: agent.Agent.StartClaudeLogin:input_type -> agent.StartClaudeLoginRequest
	165, // 138: agent.Worker.RunTurn:input_type -> agent.HostToWorker
	13,  // 139: agent.Agent.ProcessRequest:output_type -> agent.ProcessRequestResponse
	3,   // 140: agent.Agent.StreamProcessRequest:output_type -> agent.StreamProcessResponse
	3,   // 141: agent.Agent.AttachConversation:output_type -> agent.StreamProcessResponse
	12,  // 142: agent.Agent.UpdateConfig:output_type -> agent.UpdateConfigResponse
	95,  // 143: agent.Agent.GetConfig:output_type -> agent.GetConfigResponse
	49,  // 144: agent.Agent.ListConversations:output_type -> agent.ListConversationsResponse
	51,  // 145: agent.Agent.ResumeConversation:output_type -> agent.ResumeConversationResponse
	53,  // 146: agent.Agent.DeleteConversation:output_type -> agent.DeleteConversationResponse
	55,  // 147: agent.Agent.RenameConversation:output_type -> agent.RenameConversationResponse
	46,  // 148: agent.Agent.GetConversation:output_type -> agent.Conversation
	58,  // 149: agent.Agent.ListSubAgents:output_type -> agent.ListSubAgentsResponse
	60,  // 150: agent.Agent.DismissSubAgent:output_type -> agent.DismissSubAgentResponse
	63,  // 151: agent.Agent.GetContextUsage:output_type -> agent.GetContextUsageResponse
	67,  // 152: agent.Agent.GetCompactionState:output_type -> agent.GetCompactionStateResponse
	69,  // 153: agent.Agent.ElideContext:output_type -> agent.ElideContextResponse
	65,  // 154: agent.Agent.SuggestNextPrompt:output_type -> agent.SuggestNextPromptResponse
	112, // 155: agent.Agent.GetOpenRuntimeStatus:output_type -> agent.GetOpenRuntimeStatusResponse
	114, // 156: agent.Agent.InstallOpenRuntime:output_type -> agent.InstallProgress
	116, // 157: agent.Agent.RegenerateContext:output_type -> agent.RegenerateContextProgress
	71,  // 158: agent.Agent.ExportContext:output_type -> agent.ExportContextResponse
	77,  // 159: agent.Agent.ExportTrajectory:output_type -> agent.ExportTrajectoryEvent
	79,  // 160: agent.Agent.GetConversationTurns:output_type -> agent.GetConversationTurnsResponse
	81,  // 161: agent.Agent.GetToolCall:output_type -> agent.GetToolCallResponse
	89,  // 162: agent.Agent.ListTools:output_type -> agent.ListToolsResponse
	91,  // 163: agent.Agent.InvokeTool:output_type -> agent.InvokeToolResponse
	93,  // 164: agent.Agent.InvokeCapability:output_type -> agent.InvokeCapabilityResponse
	18,  // 165: agent.Agent.ListModels:output_type -> agent.ListModelsResponse
	24,  // 166: agent.Agent.GetRuntimeStatus:output_type -> agent.GetRuntimeStatusResponse
	26,  // 167: agent.Agent.ListRuntimeModels:output_type -> agent.ListRuntimeModelsResponse
	32,  // 168: agent.Agent.ListRuntimeEndpoints:output_type -> agent.ListRuntimeEndpointsResponse
	34,  // 169: agent.Agent.StartRuntimeModel:output_type -> agent.StartRuntimeModelResponse
	36,  // 170: agent.Agent.StopRuntimeModel:output_type -> agent.StopRuntimeModelResponse
	38,  // 171: agent.Agent.RestartRuntime:output_type -> agent.RestartRuntimeResponse
	40,  // 172: agent.Agent.DownloadRuntimeModel:output_type -> agent.DownloadRuntimeModelResponse
	42,  // 173: agent.Agent.CancelRuntimeModelDownload:output_type -> agent.CancelRuntimeModelDownloadResponse
	44,  // 174: agent.Agent.DeleteRuntimeModel:output_type -> agent.DeleteRuntimeModelResponse
	30,  // 175: agent.Agent.RefreshOnlineCatalog:output_type -> agent.RefreshOnlineCatalogResponse
	28,  // 176: agent.Agent.GetModelRAMEstimate:output_type -> agent.GetModelRAMEstimateResponse
	22,  // 177: agent.Agent.StreamRuntimeLogs:output_type -> agent.RuntimeLogEntry
	98,  // 178: agent.Agent.ListSkills:output_type -> agent.ListSkillsResponse
	100, // 179: agent.Agent.GetSkill:output_type -> agent.GetSkillResponse
	102, // 180: agent.Agent.SetPermissionMode:output_type -> agent.SetPermissionModeResponse
	104, // 181: agent.Agent.GetPermissionMode:output_type -> agent.GetPermissionModeResponse
	106, // 182: agent.Agent.SubscribeEvents:output_type -> agent.ClientEvent
	118, // 183: agent.Agent.AllowToolCall:output_type -> agent.AllowToolCallResponse
	120, // 184: agent.Agent.DenyToolCall:output_type -> agent.DenyToolCallResponse
	122, // 185: agent.Agent.AcceptRollover:output_type -> agent.AcceptRolloverResponse
	124, // 186: agent.Agent.DeclineRollover:output_type -> agent.DeclineRolloverResponse
	126, // 187: agent.Agent.GetProviderCapabilities:output_type -> agent.GetProviderCapabilitiesResponse
	84,  // 188: agent.Agent.ProposeContextEdit:output_type -> agent.ProposeContextEditResponse
	86,  // 189: agent.Agent.DeleteConversationTurns:output_type -> agent.DeleteConversationTurnsResponse
	134, // 190: agent.Agent.ListMcpServers:output_type -> agent.ListMcpServersResponse
	136, // 191: agent.Agent.AddMcpServer:output_type -> agent.AddMcpServerResponse
	138, // 192: agent.Agent.RemoveMcpServer:output_type -> agent.RemoveMcpServerResponse
	140, // 193: agent.Agent.RestartMcpServer:output_type -> agent.RestartMcpServerResponse
	143, // 194: agent.Agent.GetCloudProfiles:output_type -> agent.GetCloudProfilesResponse
	146, // 195: agent.Agent.GetCloudProviders:output_type -> agent.GetCloudProvidersResponse
	148, // 196: agent.Agent.SetActiveCloudProfile:output_type -> agent.SetActiveCloudProfileResponse
	150, // 197: agent.Agent.SetBackupCloudProfile:output_type -> agent.SetBackupCloudProfileResponse
	152, // 198: agent.Agent.SetCloudProfileKey:output_type -> agent.SetCloudProfileKeyResponse
	154, // 199: agent.Agent.UpsertCloudProfile:output_type -> agent.UpsertCloudProfileResponse
	156, // 200: agent.Agent.RemoveCloudProfile:output_type -> agent.RemoveCloudProfileResponse
	159, // 201: agent.Agent.ListCloudProfileModels:output_type -> agent.ListCloudProfileModelsResponse
	161, // 202: agent.Agent.StartChatGPTLogin:output_type -> agent.StartChatGPTLoginEvent
	163, // 203: agent.Agent.StartClaudeLogin:output_type -> agent.StartClaudeLoginEvent
	166, // 204: agent.Worker.RunTurn:output_type -> agent.WorkerToHost
...
func file_agent_proto_init() {
	...
	file_agent_proto_msgTypes[75].OneofWrappers = []any{
	...
	file_agent_proto_msgTypes[163].OneofWrappers = []any{
	...
	file_agent_proto_msgTypes[164].OneofWrappers = []any{
	...
	file_agent_proto_msgTypes[179].OneofWrappers = []any{}
