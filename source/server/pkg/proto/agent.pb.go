...
type UpdateConfigRequest struct {
	...
	WatchdogMode          string `protobuf:"bytes,11,opt,name=watchdog_mode,json=watchdogMode,proto3" json:"watchdog_mode,omitempty"`                              // "" = unchanged; "challenge-and-justify"|"strict"
	WatchdogChecks        string `protobuf:"bytes,12,opt,name=watchdog_checks,json=watchdogChecks,proto3" json:"watchdog_checks,omitempty"`                        // "" = unchanged; "-" = empty; else comma-joined
	WatchdogEscalateAfter string `protobuf:"bytes,13,opt,name=watchdog_escalate_after,json=watchdogEscalateAfter,proto3" json:"watchdog_escalate_after,omitempty"` // "" = unchanged; positive int
	unknownFields         protoimpl.UnknownFields
	sizeCache             protoimpl.SizeCache
}
...
type GetConfigResponse struct {
	...
	WatchdogMode          string `protobuf:"bytes,14,opt,name=watchdog_mode,json=watchdogMode,proto3" json:"watchdog_mode,omitempty"`
	WatchdogChecks        string `protobuf:"bytes,15,opt,name=watchdog_checks,json=watchdogChecks,proto3" json:"watchdog_checks,omitempty"`                        // comma-joined
	WatchdogEscalateAfter string `protobuf:"bytes,16,opt,name=watchdog_escalate_after,json=watchdogEscalateAfter,proto3" json:"watchdog_escalate_after,omitempty"` // int as string
	unknownFields         protoimpl.UnknownFields
	sizeCache             protoimpl.SizeCache
}
...
const file_agent_proto_rawDesc = "" +
	...
	"\n" +
	"media_type\x18\x03 \x01(\tR\tmediaType\"\x81\x04\n" +
	...
	"\rwatchdog_mode\x18\v \x01(\tR\fwatchdogMode\x12'\n" +
	"\x0fwatchdog_checks\x18\f \x01(\tR\x0ewatchdogChecks\x126\n" +
	"\x17watchdog_escalate_after\x18\r \x01(\tR\x15watchdogEscalateAfter\"J\n" +
	...
	"\rwatchdog_mode\x18\x0e \x01(\tR\fwatchdogMode\x12'\n" +
	"\x0fwatchdog_checks\x18\x0f \x01(\tR\x0ewatchdogChecks\x126\n" +
	"\x17watchdog_escalate_after\x18\x10 \x01(\tR\x15watchdogEscalateAfter\"\x13\n" +
