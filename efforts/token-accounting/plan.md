...
- [ ] Reproduce silent collector overflow and missing failure/early-stream usage with controlled probes before applying fixes.
- [ ] Trace server and worker startup wiring to investigate missing recent accounting; document what is proven and what historical evidence cannot establish.
