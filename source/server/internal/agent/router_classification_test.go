...
func TestRouter_ClassifiesUnitTestGenerationAsLocal(t *testing.T) {
	...
	r, err := NewSmartRouter(openProvider, cloudProvider, "nomic-embed-text", embedder, "prototypes.yaml", func(ctx context.Context, provider, model, apiKey, baseURL string) (TurnRunner, error) {
