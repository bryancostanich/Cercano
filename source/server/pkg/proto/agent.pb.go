...
const file_agent_proto_rawDesc = "" +
	...
	"\x0fconversation_id\x18\x01 \x01(\tR\x0econversationId\"\x89\x05\n" +
	"\fHostToWorker\x12(\n" +
	...
	"\tmcp_allow\x18\x02 \x03(\tR\bmcpAllow\"\xbb\x06\n" +
	"\fWorkerToHost\x12*\n" +
...
var file_agent_proto_msgTypes = make([]protoimpl.MessageInfo, 245)
var file_agent_proto_goTypes = []any{
	...
	(*ResetSetupRequest)(nil),                      // 227: agent.ResetSetupRequest
	(*ResetSetupResponse)(nil),                     // 228: agent.ResetSetupResponse
	(*AccountingAttemptObservation)(nil),           // 229: agent.AccountingAttemptObservation
	(*WorkerAccountingBatch)(nil),                  // 230: agent.WorkerAccountingBatch
	(*WorkerAccountingReceipt)(nil),                // 231: agent.WorkerAccountingReceipt
	(*WorkerAccountingHealth)(nil),                 // 232: agent.WorkerAccountingHealth
	(*AccountingWork)(nil),                         // 233: agent.AccountingWork
	(*GetTokenMetricsRequest)(nil),                 // 234: agent.GetTokenMetricsRequest
	(*TokenMetricCount)(nil),                       // 235: agent.TokenMetricCount
	(*TokenMetricTotals)(nil),                      // 236: agent.TokenMetricTotals
	(*TokenMetricBucket)(nil),                      // 237: agent.TokenMetricBucket
	(*TokenMetricBreakdown)(nil),                   // 238: agent.TokenMetricBreakdown
	(*TokenMetricsHealth)(nil),                     // 239: agent.TokenMetricsHealth
	(*GetTokenMetricsResponse)(nil),                // 240: agent.GetTokenMetricsResponse
	nil,                                            // 241: agent.ListRuntimeModelsResponse.RecommendedOpenModelsEntry
	nil,                                            // 242: agent.GetConfigResponse.ModelTiersEntry
	nil,                                            // 243: agent.McpServerInfo.EnvEntry
	nil,                                            // 244: agent.AddMcpServerRequest.EnvEntry
	nil,                                            // 245: agent.ProfileModelChoices.TierOverridesEntry
	nil,                                            // 246: agent.RoutingAssignments.TasksEntry
	nil,                                            // 247: agent.CloudProfileInfo.EffectiveQualityModelsEntry
	nil,                                            // 248: agent.CloudProfileInfo.RecommendedQualityModelsEntry
}
var file_agent_proto_depIdxs = []int32{
	...
	241, // 26: agent.ListRuntimeModelsResponse.recommended_open_models:type_name -> agent.ListRuntimeModelsResponse.RecommendedOpenModelsEntry
	...
	242, // 44: agent.GetConfigResponse.model_tiers:type_name -> agent.GetConfigResponse.ModelTiersEntry
	...
	243, // 52: agent.McpServerInfo.env:type_name -> agent.McpServerInfo.EnvEntry
	148, // 53: agent.ListMcpServersResponse.servers:type_name -> agent.McpServerInfo
	244, // 54: agent.AddMcpServerRequest.env:type_name -> agent.AddMcpServerRequest.EnvEntry
	245, // 55: agent.ProfileModelChoices.tier_overrides:type_name -> agent.ProfileModelChoices.TierOverridesEntry
	246, // 56: agent.RoutingAssignments.tasks:type_name -> agent.RoutingAssignments.TasksEntry
	...
	247, // 60: agent.CloudProfileInfo.effective_quality_models:type_name -> agent.CloudProfileInfo.EffectiveQualityModelsEntry
	248, // 61: agent.CloudProfileInfo.recommended_quality_models:type_name -> agent.CloudProfileInfo.RecommendedQualityModelsEntry
	...
	192, // 81: agent.WorkerToHost.event:type_name -> agent.WorkerEvent
	193, // 82: agent.WorkerToHost.perm_request:type_name -> agent.PermissionRequest
	197, // 83: agent.WorkerToHost.persist:type_name -> agent.PersistTurn
	199, // 84: agent.WorkerToHost.done:type_name -> agent.TurnDone
	200, // 85: agent.WorkerToHost.error:type_name -> agent.TurnError
	204, // 86: agent.WorkerToHost.cred_request:type_name -> agent.CredentialRequest
	198, // 87: agent.WorkerToHost.ensure_subagent:type_name -> agent.EnsureSubagentConversation
	206, // 88: agent.WorkerToHost.open_request:type_name -> agent.OpenInferenceRequest
	195, // 89: agent.WorkerToHost.profile_request:type_name -> agent.SessionProfileRequest
	213, // 90: agent.WorkerToHost.request_accounting:type_name -> agent.RuntimeRequestAccounting
	219, // 91: agent.WorkerToHost.auth_request:type_name -> agent.WorkerAuthenticationRequest
	222, // 92: agent.WorkerToHost.runtime_request:type_name -> agent.RuntimeRestartToolRequest
	225, // 93: agent.WorkerToHost.mcp_request:type_name -> agent.McpCallRequest
	233, // 94: agent.StartTurn.accounting:type_name -> agent.AccountingWork
	16,  // 95: agent.StartTurn.images:type_name -> agent.InlineImage
	202, // 96: agent.StartTurn.config:type_name -> agent.ConfigSnapshot
	191, // 97: agent.StartTurn.history:type_name -> agent.LLMMessage
	224, // 98: agent.StartTurn.mcp_tools:type_name -> agent.McpToolDescriptor
	1,   // 99: agent.WorkerEvent.kind:type_name -> agent.WorkerEventKind
	211, // 100: agent.WorkerEvent.route:type_name -> agent.ServingRouteInfo
	191, // 101: agent.PersistTurn.message:type_name -> agent.LLMMessage
	211, // 102: agent.TurnDone.route:type_name -> agent.ServingRouteInfo
	203, // 103: agent.ConfigSnapshot.model_metadata:type_name -> agent.ModelMetadataEntry
	160, // 104: agent.ConfigSnapshot.routing:type_name -> agent.RoutingSnapshot
	3,   // 105: agent.ModelMetadataEntry.vision:type_name -> agent.ModelMetadataEntry.Vision
	216, // 106: agent.CredentialResponse.failure:type_name -> agent.CredentialFailure
	207, // 107: agent.OpenInferenceRequest.request:type_name -> agent.LLMChatRequest
	191, // 108: agent.LLMChatRequest.messages:type_name -> agent.LLMMessage
	208, // 109: agent.LLMChatRequest.tools:type_name -> agent.LLMTool
	210, // 110: agent.OpenInferenceEvent.event:type_name -> agent.LLMStreamEvent
	211, // 111: agent.LLMStreamEvent.route:type_name -> agent.ServingRouteInfo
	217, // 112: agent.WorkerAuthenticationRequest.challenge:type_name -> agent.AuthenticationRequired
	229, // 113: agent.WorkerAccountingBatch.observations:type_name -> agent.AccountingAttemptObservation
	232, // 114: agent.WorkerAccountingBatch.health:type_name -> agent.WorkerAccountingHealth
	235, // 115: agent.TokenMetricTotals.input:type_name -> agent.TokenMetricCount
	235, // 116: agent.TokenMetricTotals.output:type_name -> agent.TokenMetricCount
	235, // 117: agent.TokenMetricTotals.cache_read:type_name -> agent.TokenMetricCount
	235, // 118: agent.TokenMetricTotals.cache_write:type_name -> agent.TokenMetricCount
	235, // 119: agent.TokenMetricTotals.reasoning:type_name -> agent.TokenMetricCount
	236, // 120: agent.TokenMetricBucket.totals:type_name -> agent.TokenMetricTotals
	236, // 121: agent.TokenMetricBreakdown.totals:type_name -> agent.TokenMetricTotals
	236, // 122: agent.GetTokenMetricsResponse.totals:type_name -> agent.TokenMetricTotals
	237, // 123: agent.GetTokenMetricsResponse.buckets:type_name -> agent.TokenMetricBucket
	238, // 124: agent.GetTokenMetricsResponse.breakdowns:type_name -> agent.TokenMetricBreakdown
	239, // 125: agent.GetTokenMetricsResponse.health:type_name -> agent.TokenMetricsHealth
	158, // 126: agent.RoutingAssignments.TasksEntry.value:type_name -> agent.TaskModelAssignment
	15,  // 127: agent.Agent.ProcessRequest:input_type -> agent.ProcessRequestRequest
	15,  // 128: agent.Agent.StreamProcessRequest:input_type -> agent.ProcessRequestRequest
	186, // 129: agent.Agent.AttachConversation:input_type -> agent.AttachConversationRequest
	17,  // 130: agent.Agent.UpdateConfig:input_type -> agent.UpdateConfigRequest
	227, // 131: agent.Agent.ResetSetup:input_type -> agent.ResetSetupRequest
	19,  // 132: agent.Agent.ShutdownAgent:input_type -> agent.ShutdownAgentRequest
	105, // 133: agent.Agent.GetConfig:input_type -> agent.GetConfigRequest
	56,  // 134: agent.Agent.ListConversations:input_type -> agent.ListConversationsRequest
	58,  // 135: agent.Agent.ResumeConversation:input_type -> agent.ResumeConversationRequest
	58,  // 136: agent.Agent.StreamResumeConversation:input_type -> agent.ResumeConversationRequest
	61,  // 137: agent.Agent.StreamResumeConversationViewportFirst:input_type -> agent.ResumeConversationViewportFirstRequest
	63,  // 138: agent.Agent.DeleteConversation:input_type -> agent.DeleteConversationRequest
	65,  // 139: agent.Agent.RenameConversation:input_type -> agent.RenameConversationRequest
	67,  // 140: agent.Agent.GetConversation:input_type -> agent.GetConversationRequest
	68,  // 141: agent.Agent.ListSubAgents:input_type -> agent.ListSubAgentsRequest
	70,  // 142: agent.Agent.DismissSubAgent:input_type -> agent.DismissSubAgentRequest
	73,  // 143: agent.Agent.GetContextUsage:input_type -> agent.GetContextUsageRequest
	234, // 144: agent.Agent.GetTokenMetrics:input_type -> agent.GetTokenMetricsRequest
	77,  // 145: agent.Agent.GetCompactionState:input_type -> agent.GetCompactionStateRequest
	79,  // 146: agent.Agent.ElideContext:input_type -> agent.ElideContextRequest
	75,  // 147: agent.Agent.SuggestNextPrompt:input_type -> agent.SuggestNextPromptRequest
	127, // 148: agent.Agent.GetOpenRuntimeStatus:input_type -> agent.GetOpenRuntimeStatusRequest
	129, // 149: agent.Agent.InstallOpenRuntime:input_type -> agent.InstallOpenRuntimeRequest
	131, // 150: agent.Agent.RegenerateContext:input_type -> agent.RegenerateContextRequest
	81,  // 151: agent.Agent.ExportContext:input_type -> agent.ExportContextRequest
	83,  // 152: agent.Agent.ExportTrajectory:input_type -> agent.ExportTrajectoryRequest
	89,  // 153: agent.Agent.GetConversationTurns:input_type -> agent.GetConversationTurnsRequest
	91,  // 154: agent.Agent.GetToolCall:input_type -> agent.GetToolCallRequest
	99,  // 155: agent.Agent.ListTools:input_type -> agent.ListToolsRequest
	101, // 156: agent.Agent.InvokeTool:input_type -> agent.InvokeToolRequest
	103, // 157: agent.Agent.InvokeCapability:input_type -> agent.InvokeCapabilityRequest
	24,  // 158: agent.Agent.ListModels:input_type -> agent.ListModelsRequest
	31,  // 159: agent.Agent.GetRuntimeStatus:input_type -> agent.GetRuntimeStatusRequest
	33,  // 160: agent.Agent.ListRuntimeModels:input_type -> agent.ListRuntimeModelsRequest
	39,  // 161: agent.Agent.ListRuntimeEndpoints:input_type -> agent.ListRuntimeEndpointsRequest
	41,  // 162: agent.Agent.StartRuntimeModel:input_type -> agent.StartRuntimeModelRequest
	43,  // 163: agent.Agent.StopRuntimeModel:input_type -> agent.StopRuntimeModelRequest
	45,  // 164: agent.Agent.RestartRuntime:input_type -> agent.RestartRuntimeRequest
	47,  // 165: agent.Agent.DownloadRuntimeModel:input_type -> agent.DownloadRuntimeModelRequest
	49,  // 166: agent.Agent.CancelRuntimeModelDownload:input_type -> agent.CancelRuntimeModelDownloadRequest
	51,  // 167: agent.Agent.DeleteRuntimeModel:input_type -> agent.DeleteRuntimeModelRequest
	37,  // 168: agent.Agent.RefreshOnlineCatalog:input_type -> agent.RefreshOnlineCatalogRequest
	35,  // 169: agent.Agent.GetModelRAMEstimate:input_type -> agent.GetModelRAMEstimateRequest
	53,  // 170: agent.Agent.StreamRuntimeLogs:input_type -> agent.StreamRuntimeLogsRequest
	107, // 171: agent.Agent.ListSkills:input_type -> agent.ListSkillsRequest
	110, // 172: agent.Agent.GetSkill:input_type -> agent.GetSkillRequest
	112, // 173: agent.Agent.SetPermissionMode:input_type -> agent.SetPermissionModeRequest
	114, // 174: agent.Agent.GetPermissionMode:input_type -> agent.GetPermissionModeRequest
	116, // 175: agent.Agent.SetSessionProfile:input_type -> agent.SetSessionProfileRequest
	118, // 176: agent.Agent.GetSessionProfile:input_type -> agent.GetSessionProfileRequest
	120, // 177: agent.Agent.SubscribeEvents:input_type -> agent.SubscribeEventsRequest
	133, // 178: agent.Agent.AllowToolCall:input_type -> agent.AllowToolCallRequest
	135, // 179: agent.Agent.DenyToolCall:input_type -> agent.DenyToolCallRequest
	137, // 180: agent.Agent.AcceptRollover:input_type -> agent.AcceptRolloverRequest
	139, // 181: agent.Agent.DeclineRollover:input_type -> agent.DeclineRolloverRequest
	141, // 182: agent.Agent.GetProviderCapabilities:input_type -> agent.GetProviderCapabilitiesRequest
	94,  // 183: agent.Agent.ProposeContextEdit:input_type -> agent.ProposeContextEditRequest
	96,  // 184: agent.Agent.DeleteConversationTurns:input_type -> agent.DeleteConversationTurnsRequest
	149, // 185: agent.Agent.ListMcpServers:input_type -> agent.ListMcpServersRequest
	151, // 186: agent.Agent.AddMcpServer:input_type -> agent.AddMcpServerRequest
	153, // 187: agent.Agent.RemoveMcpServer:input_type -> agent.RemoveMcpServerRequest
	155, // 188: agent.Agent.RestartMcpServer:input_type -> agent.RestartMcpServerRequest
	162, // 189: agent.Agent.GetCloudProfiles:input_type -> agent.GetCloudProfilesRequest
	165, // 190: agent.Agent.GetCloudProviders:input_type -> agent.GetCloudProvidersRequest
	167, // 191: agent.Agent.UpdateRoutingAssignments:input_type -> agent.UpdateRoutingAssignmentsRequest
	169, // 192: agent.Agent.SetActiveCloudProfile:input_type -> agent.SetActiveCloudProfileRequest
	171, // 193: agent.Agent.SetBackupCloudProfile:input_type -> agent.SetBackupCloudProfileRequest
	173, // 194: agent.Agent.SetCloudProfileKey:input_type -> agent.SetCloudProfileKeyRequest
	175, // 195: agent.Agent.UpsertCloudProfile:input_type -> agent.UpsertCloudProfileRequest
	177, // 196: agent.Agent.RemoveCloudProfile:input_type -> agent.RemoveCloudProfileRequest
	180, // 197: agent.Agent.ListCloudProfileModels:input_type -> agent.ListCloudProfileModelsRequest
	182, // 198: agent.Agent.StartChatGPTLogin:input_type -> agent.StartChatGPTLoginRequest
	184, // 199: agent.Agent.StartClaudeLogin:input_type -> agent.StartClaudeLoginRequest
	214, // 200: agent.Agent.ReauthenticateCloud:input_type -> agent.CloudReauthenticationRequest
	218, // 201: agent.Agent.ResolveAuthentication:input_type -> agent.AuthenticationDecisionRequest
	4,   // 202: agent.Agent.ExportImage:input_type -> agent.ExportImageRequest
	231, // 203: agent.Worker.Accounting:input_type -> agent.WorkerAccountingReceipt
	187, // 204: agent.Worker.RunTurn:input_type -> agent.HostToWorker
	187, // 205: agent.Worker.RunTurnWithAuthentication:input_type -> agent.HostToWorker
	21,  // 206: agent.Agent.ProcessRequest:output_type -> agent.ProcessRequestResponse
	7,   // 207: agent.Agent.StreamProcessRequest:output_type -> agent.StreamProcessResponse
	7,   // 208: agent.Agent.AttachConversation:output_type -> agent.StreamProcessResponse
	18,  // 209: agent.Agent.UpdateConfig:output_type -> agent.UpdateConfigResponse
	228, // 210: agent.Agent.ResetSetup:output_type -> agent.ResetSetupResponse
	20,  // 211: agent.Agent.ShutdownAgent:output_type -> agent.ShutdownAgentResponse
	106, // 212: agent.Agent.GetConfig:output_type -> agent.GetConfigResponse
	57,  // 213: agent.Agent.ListConversations:output_type -> agent.ListConversationsResponse
	59,  // 214: agent.Agent.ResumeConversation:output_type -> agent.ResumeConversationResponse
	60,  // 215: agent.Agent.StreamResumeConversation:output_type -> agent.ResumeConversationChunk
	62,  // 216: agent.Agent.StreamResumeConversationViewportFirst:output_type -> agent.ResumeConversationViewportFirstEvent
	64,  // 217: agent.Agent.DeleteConversation:output_type -> agent.DeleteConversationResponse
	66,  // 218: agent.Agent.RenameConversation:output_type -> agent.RenameConversationResponse
	54,  // 219: agent.Agent.GetConversation:output_type -> agent.Conversation
	69,  // 220: agent.Agent.ListSubAgents:output_type -> agent.ListSubAgentsResponse
	71,  // 221: agent.Agent.DismissSubAgent:output_type -> agent.DismissSubAgentResponse
	74,  // 222: agent.Agent.GetContextUsage:output_type -> agent.GetContextUsageResponse
	240, // 223: agent.Agent.GetTokenMetrics:output_type -> agent.GetTokenMetricsResponse
	78,  // 224: agent.Agent.GetCompactionState:output_type -> agent.GetCompactionStateResponse
	80,  // 225: agent.Agent.ElideContext:output_type -> agent.ElideContextResponse
	76,  // 226: agent.Agent.SuggestNextPrompt:output_type -> agent.SuggestNextPromptResponse
	128, // 227: agent.Agent.GetOpenRuntimeStatus:output_type -> agent.GetOpenRuntimeStatusResponse
	130, // 228: agent.Agent.InstallOpenRuntime:output_type -> agent.InstallProgress
	132, // 229: agent.Agent.RegenerateContext:output_type -> agent.RegenerateContextProgress
	82,  // 230: agent.Agent.ExportContext:output_type -> agent.ExportContextResponse
	88,  // 231: agent.Agent.ExportTrajectory:output_type -> agent.ExportTrajectoryEvent
	90,  // 232: agent.Agent.GetConversationTurns:output_type -> agent.GetConversationTurnsResponse
	92,  // 233: agent.Agent.GetToolCall:output_type -> agent.GetToolCallResponse
	100, // 234: agent.Agent.ListTools:output_type -> agent.ListToolsResponse
	102, // 235: agent.Agent.InvokeTool:output_type -> agent.InvokeToolResponse
	104, // 236: agent.Agent.InvokeCapability:output_type -> agent.InvokeCapabilityResponse
	26,  // 237: agent.Agent.ListModels:output_type -> agent.ListModelsResponse
	32,  // 238: agent.Agent.GetRuntimeStatus:output_type -> agent.GetRuntimeStatusResponse
	34,  // 239: agent.Agent.ListRuntimeModels:output_type -> agent.ListRuntimeModelsResponse
	40,  // 240: agent.Agent.ListRuntimeEndpoints:output_type -> agent.ListRuntimeEndpointsResponse
	42,  // 241: agent.Agent.StartRuntimeModel:output_type -> agent.StartRuntimeModelResponse
	44,  // 242: agent.Agent.StopRuntimeModel:output_type -> agent.StopRuntimeModelResponse
	46,  // 243: agent.Agent.RestartRuntime:output_type -> agent.RestartRuntimeResponse
	48,  // 244: agent.Agent.DownloadRuntimeModel:output_type -> agent.DownloadRuntimeModelResponse
	50,  // 245: agent.Agent.CancelRuntimeModelDownload:output_type -> agent.CancelRuntimeModelDownloadResponse
	52,  // 246: agent.Agent.DeleteRuntimeModel:output_type -> agent.DeleteRuntimeModelResponse
	38,  // 247: agent.Agent.RefreshOnlineCatalog:output_type -> agent.RefreshOnlineCatalogResponse
	36,  // 248: agent.Agent.GetModelRAMEstimate:output_type -> agent.GetModelRAMEstimateResponse
	30,  // 249: agent.Agent.StreamRuntimeLogs:output_type -> agent.RuntimeLogEntry
	109, // 250: agent.Agent.ListSkills:output_type -> agent.ListSkillsResponse
	111, // 251: agent.Agent.GetSkill:output_type -> agent.GetSkillResponse
	113, // 252: agent.Agent.SetPermissionMode:output_type -> agent.SetPermissionModeResponse
	115, // 253: agent.Agent.GetPermissionMode:output_type -> agent.GetPermissionModeResponse
	117, // 254: agent.Agent.SetSessionProfile:output_type -> agent.SetSessionProfileResponse
	119, // 255: agent.Agent.GetSessionProfile:output_type -> agent.GetSessionProfileResponse
	121, // 256: agent.Agent.SubscribeEvents:output_type -> agent.ClientEvent
	134, // 257: agent.Agent.AllowToolCall:output_type -> agent.AllowToolCallResponse
	136, // 258: agent.Agent.DenyToolCall:output_type -> agent.DenyToolCallResponse
	138, // 259: agent.Agent.AcceptRollover:output_type -> agent.AcceptRolloverResponse
	140, // 260: agent.Agent.DeclineRollover:output_type -> agent.DeclineRolloverResponse
	142, // 261: agent.Agent.GetProviderCapabilities:output_type -> agent.GetProviderCapabilitiesResponse
	95,  // 262: agent.Agent.ProposeContextEdit:output_type -> agent.ProposeContextEditResponse
	97,  // 263: agent.Agent.DeleteConversationTurns:output_type -> agent.DeleteConversationTurnsResponse
	150, // 264: agent.Agent.ListMcpServers:output_type -> agent.ListMcpServersResponse
	152, // 265: agent.Agent.AddMcpServer:output_type -> agent.AddMcpServerResponse
	154, // 266: agent.Agent.RemoveMcpServer:output_type -> agent.RemoveMcpServerResponse
	156, // 267: agent.Agent.RestartMcpServer:output_type -> agent.RestartMcpServerResponse
	163, // 268: agent.Agent.GetCloudProfiles:output_type -> agent.GetCloudProfilesResponse
	166, // 269: agent.Agent.GetCloudProviders:output_type -> agent.GetCloudProvidersResponse
	168, // 270: agent.Agent.UpdateRoutingAssignments:output_type -> agent.UpdateRoutingAssignmentsResponse
	170, // 271: agent.Agent.SetActiveCloudProfile:output_type -> agent.SetActiveCloudProfileResponse
	172, // 272: agent.Agent.SetBackupCloudProfile:output_type -> agent.SetBackupCloudProfileResponse
	174, // 273: agent.Agent.SetCloudProfileKey:output_type -> agent.SetCloudProfileKeyResponse
	176, // 274: agent.Agent.UpsertCloudProfile:output_type -> agent.UpsertCloudProfileResponse
	178, // 275: agent.Agent.RemoveCloudProfile:output_type -> agent.RemoveCloudProfileResponse
	181, // 276: agent.Agent.ListCloudProfileModels:output_type -> agent.ListCloudProfileModelsResponse
	183, // 277: agent.Agent.StartChatGPTLogin:output_type -> agent.StartChatGPTLoginEvent
	185, // 278: agent.Agent.StartClaudeLogin:output_type -> agent.StartClaudeLoginEvent
	215, // 279: agent.Agent.ReauthenticateCloud:output_type -> agent.CloudLoginEvent
	221, // 280: agent.Agent.ResolveAuthentication:output_type -> agent.AuthenticationDecisionResponse
	5,   // 281: agent.Agent.ExportImage:output_type -> agent.ExportImageResponse
	230, // 282: agent.Worker.Accounting:output_type -> agent.WorkerAccountingBatch
	189, // 283: agent.Worker.RunTurn:output_type -> agent.WorkerToHost
	189, // 284: agent.Worker.RunTurnWithAuthentication:output_type -> agent.WorkerToHost
	206, // [206:285] is the sub-list for method output_type
	127, // [127:206] is the sub-list for method input_type
...
func file_agent_proto_init() {
	...
	file_agent_proto_msgTypes[225].OneofWrappers = []any{}
	file_agent_proto_msgTypes[228].OneofWrappers = []any{}
