...
func daylightPalette() Palette {
	return Palette{
		...
		SelectionBg: hc("#58829E"), CodeBlockBg: hc("#1A1A1A"), BypassText: hc("#FBF3E0"), ActivityBase: hc("#1E7A3C"), ActivityPeak: hc("#104321"), WordmarkPeak: hc("#7A4E0A"), SpinnerBase: hc("#5A3A0A"), SpinnerPeak: hc("#7A4E0A"), MeterLabelOnFill: hc("#5A3A0A"), SelectionCaret: hc("#B23A3A"),
...
func meadowPalette() Palette {
	return Palette{
		...
		SelectionBg: hc("#58829E"), CodeBlockBg: hc("#1A1A1A"), BypassText: hc("#EDF6E9"), ActivityBase: hc("#3C7A1E"), ActivityPeak: hc("#214310"), WordmarkPeak: hc("#1F7A28"), SpinnerBase: hc("#14571A"), SpinnerPeak: hc("#1F7A28"), MeterLabelOnFill: hc("#14571A"), SelectionCaret: hc("#B23A3A"),
...
func dawnwavePalette() Palette {
	return Palette{
		...
		SelectionBg: hc("#58829E"), CodeBlockBg: hc("#1A1A1A"), BypassText: hc("#F7EEFA"), ActivityBase: hc("#0B6D85"), ActivityPeak: hc("#07495A"), WordmarkPeak: hc("#A62E80"), SpinnerBase: hc("#7A2A6A"), SpinnerPeak: hc("#A62E80"), MeterLabelOnFill: hc("#7A2A6A"), SelectionCaret: hc("#C13060"),
