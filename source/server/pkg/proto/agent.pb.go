...
const file_agent_proto_rawDesc = "" +
	...
	"\x11StartChatGPTLogin\x12\x1f.agent.StartChatGPTLoginRequest\x1a\x1d.agent.StartChatGPTLoginEvent0\x01B!Z\x1fcercano/source/server/pkg/protob\x06proto3"
...
var file_agent_proto_msgTypes = make([]protoimpl.MessageInfo, 147)
var file_agent_proto_goTypes = []any{
	...
	(*SubAgentEvent)(nil),                      // 6: agent.SubAgentEvent
	...
	nil,                                        // 146: agent.GetConfigResponse.ModelTiersEntry
	nil,                                        // 147: agent.AddMcpServerRequest.EnvEntry
}
var file_agent_proto_depIdxs = []int32{
	...
	6,   // 10: agent.StreamProcessResponse.sub_agent_event:type_name -> agent.SubAgentEvent
	8,   // 11: agent.ProcessRequestRequest.images:type_name -> agent.InlineImage
	12,  // 12: agent.ProcessRequestResponse.file_changes:type_name -> agent.FileChange
	13,  // 13: agent.ProcessRequestResponse.routing_metadata:type_name -> agent.RoutingMetadata
	0,   // 14: agent.FileChange.action:type_name -> agent.FileAction
	15,  // 15: agent.ListModelsResponse.models:type_name -> agent.ModelInfo
	17,  // 16: agent.GetRuntimeStatusResponse.models:type_name -> agent.RuntimeModel
	18,  // 17: agent.GetRuntimeStatusResponse.instances:type_name -> agent.RuntimeInstance
	19,  // 18: agent.GetRuntimeStatusResponse.endpoints:type_name -> agent.RuntimeEndpoint
	20,  // 19: agent.GetRuntimeStatusResponse.logs:type_name -> agent.RuntimeLogEntry
	17,  // 20: agent.ListRuntimeModelsResponse.models:type_name -> agent.RuntimeModel
	19,  // 21: agent.ListRuntimeEndpointsResponse.endpoints:type_name -> agent.RuntimeEndpoint
	18,  // 22: agent.StartRuntimeModelResponse.instance:type_name -> agent.RuntimeInstance
	18,  // 23: agent.RestartRuntimeResponse.instance:type_name -> agent.RuntimeInstance
	17,  // 24: agent.DownloadRuntimeModelResponse.model:type_name -> agent.RuntimeModel
	17,  // 25: agent.CancelRuntimeModelDownloadResponse.model:type_name -> agent.RuntimeModel
	44,  // 26: agent.ListConversationsResponse.conversations:type_name -> agent.Conversation
	45,  // 27: agent.ResumeConversationResponse.turns:type_name -> agent.PersistedTurn
	67,  // 28: agent.GetConversationTurnsResponse.turns:type_name -> agent.ContextTurn
	72,  // 29: agent.ListToolsResponse.tools:type_name -> agent.BuiltinTool
	146, // 30: agent.GetConfigResponse.model_tiers:type_name -> agent.GetConfigResponse.ModelTiersEntry
	82,  // 31: agent.ListSkillsResponse.skills:type_name -> agent.SkillInfo
	92,  // 32: agent.ClientEvent.permission_mode_changed:type_name -> agent.PermissionModeChanged
	93,  // 33: agent.ClientEvent.config_changed:type_name -> agent.ConfigChanged
	95,  // 34: agent.ClientEvent.meridian_status_changed:type_name -> agent.MeridianStatusChanged
	97,  // 35: agent.ClientEvent.open_runtime_status_changed:type_name -> agent.OpenRuntimeStatusChanged
	94,  // 36: agent.MeridianStatusChanged.status:type_name -> agent.MeridianStatus
	96,  // 37: agent.OpenRuntimeStatusChanged.status:type_name -> agent.OpenRuntimeStatus
	96,  // 38: agent.GetOpenRuntimeStatusResponse.status:type_name -> agent.OpenRuntimeStatus
	115, // 39: agent.ListMcpServersResponse.servers:type_name -> agent.McpServerInfo
	147, // 40: agent.AddMcpServerRequest.env:type_name -> agent.AddMcpServerRequest.EnvEntry
	124, // 41: agent.GetCloudProfilesResponse.profiles:type_name -> agent.CloudProfileInfo
	94,  // 42: agent.GetCloudProfilesResponse.meridian_status:type_name -> agent.MeridianStatus
	124, // 43: agent.CloudProvider.profiles:type_name -> agent.CloudProfileInfo
	127, // 44: agent.GetCloudProvidersResponse.providers:type_name -> agent.CloudProvider
	124, // 45: agent.GetCloudProvidersResponse.custom_profiles:type_name -> agent.CloudProfileInfo
	94,  // 46: agent.GetCloudProvidersResponse.meridian_status:type_name -> agent.MeridianStatus
	140, // 47: agent.ListCloudProfileModelsResponse.models:type_name -> agent.CloudModelInfo
	7,   // 48: agent.Agent.ProcessRequest:input_type -> agent.ProcessRequestRequest
	7,   // 49: agent.Agent.StreamProcessRequest:input_type -> agent.ProcessRequestRequest
	145, // 50: agent.Agent.AttachConversation:input_type -> agent.AttachConversationRequest
	9,   // 51: agent.Agent.UpdateConfig:input_type -> agent.UpdateConfigRequest
	79,  // 52: agent.Agent.GetConfig:input_type -> agent.GetConfigRequest
	46,  // 53: agent.Agent.ListConversations:input_type -> agent.ListConversationsRequest
	48,  // 54: agent.Agent.ResumeConversation:input_type -> agent.ResumeConversationRequest
	50,  // 55: agent.Agent.DeleteConversation:input_type -> agent.DeleteConversationRequest
	52,  // 56: agent.Agent.RenameConversation:input_type -> agent.RenameConversationRequest
	54,  // 57: agent.Agent.GetConversation:input_type -> agent.GetConversationRequest
	55,  // 58: agent.Agent.GetContextUsage:input_type -> agent.GetContextUsageRequest
	59,  // 59: agent.Agent.GetCompactionState:input_type -> agent.GetCompactionStateRequest
	57,  // 60: agent.Agent.SuggestNextPrompt:input_type -> agent.SuggestNextPromptRequest
	98,  // 61: agent.Agent.GetOpenRuntimeStatus:input_type -> agent.GetOpenRuntimeStatusRequest
	100, // 62: agent.Agent.InstallOpenRuntime:input_type -> agent.InstallOpenRuntimeRequest
	102, // 63: agent.Agent.RegenerateContext:input_type -> agent.RegenerateContextRequest
	61,  // 64: agent.Agent.ExportContext:input_type -> agent.ExportContextRequest
	63,  // 65: agent.Agent.GetConversationTurns:input_type -> agent.GetConversationTurnsRequest
	65,  // 66: agent.Agent.GetToolCall:input_type -> agent.GetToolCallRequest
	73,  // 67: agent.Agent.ListTools:input_type -> agent.ListToolsRequest
	75,  // 68: agent.Agent.InvokeTool:input_type -> agent.InvokeToolRequest
	77,  // 69: agent.Agent.InvokeCapability:input_type -> agent.InvokeCapabilityRequest
	14,  // 70: agent.Agent.ListModels:input_type -> agent.ListModelsRequest
	21,  // 71: agent.Agent.GetRuntimeStatus:input_type -> agent.GetRuntimeStatusRequest
	23,  // 72: agent.Agent.ListRuntimeModels:input_type -> agent.ListRuntimeModelsRequest
	29,  // 73: agent.Agent.ListRuntimeEndpoints:input_type -> agent.ListRuntimeEndpointsRequest
	31,  // 74: agent.Agent.StartRuntimeModel:input_type -> agent.StartRuntimeModelRequest
	33,  // 75: agent.Agent.StopRuntimeModel:input_type -> agent.StopRuntimeModelRequest
	35,  // 76: agent.Agent.RestartRuntime:input_type -> agent.RestartRuntimeRequest
	37,  // 77: agent.Agent.DownloadRuntimeModel:input_type -> agent.DownloadRuntimeModelRequest
	39,  // 78: agent.Agent.CancelRuntimeModelDownload:input_type -> agent.CancelRuntimeModelDownloadRequest
	41,  // 79: agent.Agent.DeleteRuntimeModel:input_type -> agent.DeleteRuntimeModelRequest
	27,  // 80: agent.Agent.RefreshOnlineCatalog:input_type -> agent.RefreshOnlineCatalogRequest
	25,  // 81: agent.Agent.GetModelRAMEstimate:input_type -> agent.GetModelRAMEstimateRequest
	43,  // 82: agent.Agent.StreamRuntimeLogs:input_type -> agent.StreamRuntimeLogsRequest
	81,  // 83: agent.Agent.ListSkills:input_type -> agent.ListSkillsRequest
	84,  // 84: agent.Agent.GetSkill:input_type -> agent.GetSkillRequest
	86,  // 85: agent.Agent.SetPermissionMode:input_type -> agent.SetPermissionModeRequest
	88,  // 86: agent.Agent.GetPermissionMode:input_type -> agent.GetPermissionModeRequest
	90,  // 87: agent.Agent.SubscribeEvents:input_type -> agent.SubscribeEventsRequest
	104, // 88: agent.Agent.AllowToolCall:input_type -> agent.AllowToolCallRequest
	106, // 89: agent.Agent.DenyToolCall:input_type -> agent.DenyToolCallRequest
	108, // 90: agent.Agent.GetProviderCapabilities:input_type -> agent.GetProviderCapabilitiesRequest
	68,  // 91: agent.Agent.ProposeContextEdit:input_type -> agent.ProposeContextEditRequest
	70,  // 92: agent.Agent.DeleteConversationTurns:input_type -> agent.DeleteConversationTurnsRequest
	116, // 93: agent.Agent.ListMcpServers:input_type -> agent.ListMcpServersRequest
	118, // 94: agent.Agent.AddMcpServer:input_type -> agent.AddMcpServerRequest
	120, // 95: agent.Agent.RemoveMcpServer:input_type -> agent.RemoveMcpServerRequest
	122, // 96: agent.Agent.RestartMcpServer:input_type -> agent.RestartMcpServerRequest
	125, // 97: agent.Agent.GetCloudProfiles:input_type -> agent.GetCloudProfilesRequest
	128, // 98: agent.Agent.GetCloudProviders:input_type -> agent.GetCloudProvidersRequest
	130, // 99: agent.Agent.SetActiveCloudProfile:input_type -> agent.SetActiveCloudProfileRequest
	132, // 100: agent.Agent.SetBackupCloudProfile:input_type -> agent.SetBackupCloudProfileRequest
	134, // 101: agent.Agent.SetCloudProfileKey:input_type -> agent.SetCloudProfileKeyRequest
	136, // 102: agent.Agent.UpsertCloudProfile:input_type -> agent.UpsertCloudProfileRequest
	138, // 103: agent.Agent.RemoveCloudProfile:input_type -> agent.RemoveCloudProfileRequest
	141, // 104: agent.Agent.ListCloudProfileModels:input_type -> agent.ListCloudProfileModelsRequest
	143, // 105: agent.Agent.StartChatGPTLogin:input_type -> agent.StartChatGPTLoginRequest
	11,  // 106: agent.Agent.ProcessRequest:output_type -> agent.ProcessRequestResponse
	2,   // 107: agent.Agent.StreamProcessRequest:output_type -> agent.StreamProcessResponse
	2,   // 108: agent.Agent.AttachConversation:output_type -> agent.StreamProcessResponse
	10,  // 109: agent.Agent.UpdateConfig:output_type -> agent.UpdateConfigResponse
	80,  // 110: agent.Agent.GetConfig:output_type -> agent.GetConfigResponse
	47,  // 111: agent.Agent.ListConversations:output_type -> agent.ListConversationsResponse
	49,  // 112: agent.Agent.ResumeConversation:output_type -> agent.ResumeConversationResponse
	51,  // 113: agent.Agent.DeleteConversation:output_type -> agent.DeleteConversationResponse
	53,  // 114: agent.Agent.RenameConversation:output_type -> agent.RenameConversationResponse
	44,  // 115: agent.Agent.GetConversation:output_type -> agent.Conversation
	56,  // 116: agent.Agent.GetContextUsage:output_type -> agent.GetContextUsageResponse
	60,  // 117: agent.Agent.GetCompactionState:output_type -> agent.GetCompactionStateResponse
	58,  // 118: agent.Agent.SuggestNextPrompt:output_type -> agent.SuggestNextPromptResponse
	99,  // 119: agent.Agent.GetOpenRuntimeStatus:output_type -> agent.GetOpenRuntimeStatusResponse
	101, // 120: agent.Agent.InstallOpenRuntime:output_type -> agent.InstallProgress
	103, // 121: agent.Agent.RegenerateContext:output_type -> agent.RegenerateContextProgress
	62,  // 122: agent.Agent.ExportContext:output_type -> agent.ExportContextResponse
	64,  // 123: agent.Agent.GetConversationTurns:output_type -> agent.GetConversationTurnsResponse
	66,  // 124: agent.Agent.GetToolCall:output_type -> agent.GetToolCallResponse
	74,  // 125: agent.Agent.ListTools:output_type -> agent.ListToolsResponse
	76,  // 126: agent.Agent.InvokeTool:output_type -> agent.InvokeToolResponse
	78,  // 127: agent.Agent.InvokeCapability:output_type -> agent.InvokeCapabilityResponse
	16,  // 128: agent.Agent.ListModels:output_type -> agent.ListModelsResponse
	22,  // 129: agent.Agent.GetRuntimeStatus:output_type -> agent.GetRuntimeStatusResponse
	24,  // 130: agent.Agent.ListRuntimeModels:output_type -> agent.ListRuntimeModelsResponse
	30,  // 131: agent.Agent.ListRuntimeEndpoints:output_type -> agent.ListRuntimeEndpointsResponse
	32,  // 132: agent.Agent.StartRuntimeModel:output_type -> agent.StartRuntimeModelResponse
	34,  // 133: agent.Agent.StopRuntimeModel:output_type -> agent.StopRuntimeModelResponse
	36,  // 134: agent.Agent.RestartRuntime:output_type -> agent.RestartRuntimeResponse
	38,  // 135: agent.Agent.DownloadRuntimeModel:output_type -> agent.DownloadRuntimeModelResponse
	40,  // 136: agent.Agent.CancelRuntimeModelDownload:output_type -> agent.CancelRuntimeModelDownloadResponse
	42,  // 137: agent.Agent.DeleteRuntimeModel:output_type -> agent.DeleteRuntimeModelResponse
	28,  // 138: agent.Agent.RefreshOnlineCatalog:output_type -> agent.RefreshOnlineCatalogResponse
	26,  // 139: agent.Agent.GetModelRAMEstimate:output_type -> agent.GetModelRAMEstimateResponse
	20,  // 140: agent.Agent.StreamRuntimeLogs:output_type -> agent.RuntimeLogEntry
	83,  // 141: agent.Agent.ListSkills:output_type -> agent.ListSkillsResponse
	85,  // 142: agent.Agent.GetSkill:output_type -> agent.GetSkillResponse
	87,  // 143: agent.Agent.SetPermissionMode:output_type -> agent.SetPermissionModeResponse
	89,  // 144: agent.Agent.GetPermissionMode:output_type -> agent.GetPermissionModeResponse
	91,  // 145: agent.Agent.SubscribeEvents:output_type -> agent.ClientEvent
	105, // 146: agent.Agent.AllowToolCall:output_type -> agent.AllowToolCallResponse
	107, // 147: agent.Agent.DenyToolCall:output_type -> agent.DenyToolCallResponse
	109, // 148: agent.Agent.GetProviderCapabilities:output_type -> agent.GetProviderCapabilitiesResponse
	69,  // 149: agent.Agent.ProposeContextEdit:output_type -> agent.ProposeContextEditResponse
	71,  // 150: agent.Agent.DeleteConversationTurns:output_type -> agent.DeleteConversationTurnsResponse
	117, // 151: agent.Agent.ListMcpServers:output_type -> agent.ListMcpServersResponse
	119, // 152: agent.Agent.AddMcpServer:output_type -> agent.AddMcpServerResponse
	121, // 153: agent.Agent.RemoveMcpServer:output_type -> agent.RemoveMcpServerResponse
	123, // 154: agent.Agent.RestartMcpServer:output_type -> agent.RestartMcpServerResponse
	126, // 155: agent.Agent.GetCloudProfiles:output_type -> agent.GetCloudProfilesResponse
	129, // 156: agent.Agent.GetCloudProviders:output_type -> agent.GetCloudProvidersResponse
	131, // 157: agent.Agent.SetActiveCloudProfile:output_type -> agent.SetActiveCloudProfileResponse
	133, // 158: agent.Agent.SetBackupCloudProfile:output_type -> agent.SetBackupCloudProfileResponse
	135, // 159: agent.Agent.SetCloudProfileKey:output_type -> agent.SetCloudProfileKeyResponse
	137, // 160: agent.Agent.UpsertCloudProfile:output_type -> agent.UpsertCloudProfileResponse
	139, // 161: agent.Agent.RemoveCloudProfile:output_type -> agent.RemoveCloudProfileResponse
	142, // 162: agent.Agent.ListCloudProfileModels:output_type -> agent.ListCloudProfileModelsResponse
	144, // 163: agent.Agent.StartChatGPTLogin:output_type -> agent.StartChatGPTLoginEvent
