# Superseded offline design — historical record only

This design was explicitly rejected by the user in favor of reset with sessions open. It is not an active execution plan. The retained config/wizard work is still used; the lifetime-lock implementation was removed.
