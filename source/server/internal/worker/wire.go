...
func SnapshotConfig(cfg config.Config, cred string, openTiers map[string]string) *proto.ConfigSnapshot {
	...
	return &proto.ConfigSnapshot{
		...
		CompactionSummarizerModel:         cfg.Compaction.SummarizerModel,
		CompactionCompactedBudgetPct:      cfg.Compaction.CompactedBudgetPct,
		CompactionTieredRetentionSegments: int32(cfg.Compaction.TieredRetentionSegments),
...
func ConfigFromSnapshot(p *proto.ConfigSnapshot) config.Config {
	...
	cfg := config.Config{
		...
		Compaction: config.CompactionConfig{
			...
			SummarizerModel:         p.CompactionSummarizerModel,
			CompactedBudgetPct:      p.CompactionCompactedBudgetPct,
			TieredRetentionSegments: int(p.CompactionTieredRetentionSegments),
		},
