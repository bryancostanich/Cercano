...
func phosphorPalette() Palette {
	return Palette{
		...
		SelectionBg: hc("#58829E"), CodeBlockBg: hc("#1A1A1A"), BypassText: hc("#0A0F0A"), ActivityBase: hc("#7CFF4D"), ActivityPeak: hc("#9CFF9C"), WordmarkPeak: hc("#9CFF9C"), SpinnerBase: hc("#33FF33"), SpinnerPeak: hc("#9CFF9C"), MeterLabelOnFill: hc("#0A0F0A"), SelectionCaret: hc("#FFB84D"),
...
func synthwavePalette() Palette {
	return Palette{
		...
		SelectionBg: hc("#58829E"), CodeBlockBg: hc("#1A1A1A"), BypassText: hc("#1A1033"), ActivityBase: hc("#36E0E0"), ActivityPeak: hc("#FFC2F0"), WordmarkPeak: hc("#FFC2F0"), SpinnerBase: hc("#FF6AD5"), SpinnerPeak: hc("#FFC2F0"), MeterLabelOnFill: hc("#1A1033"), SelectionCaret: hc("#FFC2F0"),
...
func daylightPalette() Palette {
	return Palette{
		...
		SelectionBg: hc("#58829E"), CodeBlockBg: hc("#1A1A1A"), BypassText: hc("#FBF3E0"), ActivityBase: hc("#1E7A3C"), ActivityPeak: hc("#104321"), WordmarkPeak: hc("#7A4E0A"), SpinnerBase: hc("#3B3020"), SpinnerPeak: hc("#7A4E0A"), MeterLabelOnFill: hc("#3B3020"), SelectionCaret: hc("#8A00C2"),
...
func meadowPalette() Palette {
	return Palette{
		...
		SelectionBg: hc("#58829E"), CodeBlockBg: hc("#1A1A1A"), BypassText: hc("#EDF6E9"), ActivityBase: hc("#3C7A1E"), ActivityPeak: hc("#214310"), WordmarkPeak: hc("#1F7A28"), SpinnerBase: hc("#14571A"), SpinnerPeak: hc("#1F7A28"), MeterLabelOnFill: hc("#14571A"), SelectionCaret: hc("#8A00C2"),
...
func dawnwavePalette() Palette {
	return Palette{
		...
		SelectionBg: hc("#58829E"), CodeBlockBg: hc("#1A1A1A"), BypassText: hc("#F7EEFA"), ActivityBase: hc("#0B6D85"), ActivityPeak: hc("#07495A"), WordmarkPeak: hc("#A62E80"), SpinnerBase: hc("#7A2A6A"), SpinnerPeak: hc("#A62E80"), MeterLabelOnFill: hc("#7A2A6A"), SelectionCaret: hc("#8A00C2"),
