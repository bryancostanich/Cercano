...
- [ ] Task: Add venv creation to `cercano setup` — create `~/.config/cercano/venv/`, install `duckduckgo-search`.
- [ ] Task: Implement Go subprocess caller — spawn venv Python, parse JSON stdout, handle errors.
