...
- [-] Inspect the exact config, profile mutation, provider construction, worker credential, stream retry, and CLI draft interfaces in this baseline. Inventory all routing consumers, distinguishing explicit dispatch from other RoleCoproc work.
