...
var file_agent_proto_goTypes = []any{
	...
	(*BuiltinTool)(nil),                        // 50: agent.BuiltinTool
	(*ListToolsRequest)(nil),                   // 51: agent.ListToolsRequest
	(*ListToolsResponse)(nil),                  // 52: agent.ListToolsResponse
	(*InvokeToolRequest)(nil),                  // 53: agent.InvokeToolRequest
	(*InvokeToolResponse)(nil),                 // 54: agent.InvokeToolResponse
	(*GetConfigRequest)(nil),                   // 55: agent.GetConfigRequest
	(*GetConfigResponse)(nil),                  // 56: agent.GetConfigResponse
	(*ListSkillsRequest)(nil),                  // 57: agent.ListSkillsRequest
	(*SkillInfo)(nil),                          // 58: agent.SkillInfo
	(*ListSkillsResponse)(nil),                 // 59: agent.ListSkillsResponse
	(*GetSkillRequest)(nil),                    // 60: agent.GetSkillRequest
	(*GetSkillResponse)(nil),                   // 61: agent.GetSkillResponse
	(*SetPermissionModeRequest)(nil),           // 62: agent.SetPermissionModeRequest
	(*SetPermissionModeResponse)(nil),          // 63: agent.SetPermissionModeResponse
	(*GetPermissionModeRequest)(nil),           // 64: agent.GetPermissionModeRequest
	(*GetPermissionModeResponse)(nil),          // 65: agent.GetPermissionModeResponse
	(*AllowToolCallRequest)(nil),               // 66: agent.AllowToolCallRequest
	(*AllowToolCallResponse)(nil),              // 67: agent.AllowToolCallResponse
	(*DenyToolCallRequest)(nil),                // 68: agent.DenyToolCallRequest
	(*DenyToolCallResponse)(nil),               // 69: agent.DenyToolCallResponse
	(*GetProviderCapabilitiesRequest)(nil),     // 70: agent.GetProviderCapabilitiesRequest
	(*GetProviderCapabilitiesResponse)(nil),    // 71: agent.GetProviderCapabilitiesResponse
	(*ToolUseStart)(nil),                       // 72: agent.ToolUseStart
	(*ToolUseStop)(nil),                        // 73: agent.ToolUseStop
	(*ToolExecStart)(nil),                      // 74: agent.ToolExecStart
	(*ToolExecComplete)(nil),                   // 75: agent.ToolExecComplete
	(*PermissionRequired)(nil),                 // 76: agent.PermissionRequired
}
var file_agent_proto_depIdxs = []int32{
	...
	72, // 3: agent.StreamProcessResponse.tool_use_start:type_name -> agent.ToolUseStart
	73, // 4: agent.StreamProcessResponse.tool_use_stop:type_name -> agent.ToolUseStop
	74, // 5: agent.StreamProcessResponse.tool_exec_start:type_name -> agent.ToolExecStart
	75, // 6: agent.StreamProcessResponse.tool_exec_complete:type_name -> agent.ToolExecComplete
	76, // 7: agent.StreamProcessResponse.permission_required:type_name -> agent.PermissionRequired
	...
	50, // 25: agent.ListToolsResponse.tools:type_name -> agent.BuiltinTool
	58, // 26: agent.ListSkillsResponse.skills:type_name -> agent.SkillInfo
	5,  // 27: agent.Agent.ProcessRequest:input_type -> agent.ProcessRequestRequest
	5,  // 28: agent.Agent.StreamProcessRequest:input_type -> agent.ProcessRequestRequest
	6,  // 29: agent.Agent.UpdateConfig:input_type -> agent.UpdateConfigRequest
	55, // 30: agent.Agent.GetConfig:input_type -> agent.GetConfigRequest
	39, // 31: agent.Agent.ListConversations:input_type -> agent.ListConversationsRequest
	41, // 32: agent.Agent.ResumeConversation:input_type -> agent.ResumeConversationRequest
	43, // 33: agent.Agent.DeleteConversation:input_type -> agent.DeleteConversationRequest
	45, // 34: agent.Agent.RenameConversation:input_type -> agent.RenameConversationRequest
	47, // 35: agent.Agent.GetConversation:input_type -> agent.GetConversationRequest
	48, // 36: agent.Agent.GetContextUsage:input_type -> agent.GetContextUsageRequest
	51, // 37: agent.Agent.ListTools:input_type -> agent.ListToolsRequest
	53, // 38: agent.Agent.InvokeTool:input_type -> agent.InvokeToolRequest
	11, // 39: agent.Agent.ListModels:input_type -> agent.ListModelsRequest
	18, // 40: agent.Agent.GetRuntimeStatus:input_type -> agent.GetRuntimeStatusRequest
	20, // 41: agent.Agent.ListRuntimeModels:input_type -> agent.ListRuntimeModelsRequest
	22, // 42: agent.Agent.ListRuntimeEndpoints:input_type -> agent.ListRuntimeEndpointsRequest
	24, // 43: agent.Agent.StartRuntimeModel:input_type -> agent.StartRuntimeModelRequest
	26, // 44: agent.Agent.StopRuntimeModel:input_type -> agent.StopRuntimeModelRequest
	28, // 45: agent.Agent.RestartRuntime:input_type -> agent.RestartRuntimeRequest
	30, // 46: agent.Agent.DownloadRuntimeModel:input_type -> agent.DownloadRuntimeModelRequest
	32, // 47: agent.Agent.CancelRuntimeModelDownload:input_type -> agent.CancelRuntimeModelDownloadRequest
	34, // 48: agent.Agent.DeleteRuntimeModel:input_type -> agent.DeleteRuntimeModelRequest
	36, // 49: agent.Agent.StreamRuntimeLogs:input_type -> agent.StreamRuntimeLogsRequest
	57, // 50: agent.Agent.ListSkills:input_type -> agent.ListSkillsRequest
	60, // 51: agent.Agent.GetSkill:input_type -> agent.GetSkillRequest
	62, // 52: agent.Agent.SetPermissionMode:input_type -> agent.SetPermissionModeRequest
	64, // 53: agent.Agent.GetPermissionMode:input_type -> agent.GetPermissionModeRequest
	66, // 54: agent.Agent.AllowToolCall:input_type -> agent.AllowToolCallRequest
	68, // 55: agent.Agent.DenyToolCall:input_type -> agent.DenyToolCallRequest
	70, // 56: agent.Agent.GetProviderCapabilities:input_type -> agent.GetProviderCapabilitiesRequest
	8,  // 57: agent.Agent.ProcessRequest:output_type -> agent.ProcessRequestResponse
	2,  // 58: agent.Agent.StreamProcessRequest:output_type -> agent.StreamProcessResponse
	7,  // 59: agent.Agent.UpdateConfig:output_type -> agent.UpdateConfigResponse
	56, // 60: agent.Agent.GetConfig:output_type -> agent.GetConfigResponse
	40, // 61: agent.Agent.ListConversations:output_type -> agent.ListConversationsResponse
	42, // 62: agent.Agent.ResumeConversation:output_type -> agent.ResumeConversationResponse
	44, // 63: agent.Agent.DeleteConversation:output_type -> agent.DeleteConversationResponse
	46, // 64: agent.Agent.RenameConversation:output_type -> agent.RenameConversationResponse
	37, // 65: agent.Agent.GetConversation:output_type -> agent.Conversation
	49, // 66: agent.Agent.GetContextUsage:output_type -> agent.GetContextUsageResponse
	52, // 67: agent.Agent.ListTools:output_type -> agent.ListToolsResponse
	54, // 68: agent.Agent.InvokeTool:output_type -> agent.InvokeToolResponse
	13, // 69: agent.Agent.ListModels:output_type -> agent.ListModelsResponse
	19, // 70: agent.Agent.GetRuntimeStatus:output_type -> agent.GetRuntimeStatusResponse
	21, // 71: agent.Agent.ListRuntimeModels:output_type -> agent.ListRuntimeModelsResponse
	23, // 72: agent.Agent.ListRuntimeEndpoints:output_type -> agent.ListRuntimeEndpointsResponse
	25, // 73: agent.Agent.StartRuntimeModel:output_type -> agent.StartRuntimeModelResponse
	27, // 74: agent.Agent.StopRuntimeModel:output_type -> agent.StopRuntimeModelResponse
	29, // 75: agent.Agent.RestartRuntime:output_type -> agent.RestartRuntimeResponse
	31, // 76: agent.Agent.DownloadRuntimeModel:output_type -> agent.DownloadRuntimeModelResponse
	33, // 77: agent.Agent.CancelRuntimeModelDownload:output_type -> agent.CancelRuntimeModelDownloadResponse
	35, // 78: agent.Agent.DeleteRuntimeModel:output_type -> agent.DeleteRuntimeModelResponse
	17, // 79: agent.Agent.StreamRuntimeLogs:output_type -> agent.RuntimeLogEntry
	59, // 80: agent.Agent.ListSkills:output_type -> agent.ListSkillsResponse
	61, // 81: agent.Agent.GetSkill:output_type -> agent.GetSkillResponse
	63, // 82: agent.Agent.SetPermissionMode:output_type -> agent.SetPermissionModeResponse
	65, // 83: agent.Agent.GetPermissionMode:output_type -> agent.GetPermissionModeResponse
	67, // 84: agent.Agent.AllowToolCall:output_type -> agent.AllowToolCallResponse
	69, // 85: agent.Agent.DenyToolCall:output_type -> agent.DenyToolCallResponse
	71, // 86: agent.Agent.GetProviderCapabilities:output_type -> agent.GetProviderCapabilitiesResponse
