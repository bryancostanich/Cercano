...
const file_agent_proto_rawDesc = "" +
	...
	"\x11SuggestNextPrompt\x12\x1f.agent.SuggestNextPromptRequest\x1a .agent.SuggestNextPromptResponse\"\x00\x12L\n" +
...
var file_agent_proto_msgTypes = make([]protoimpl.MessageInfo, 119)
var file_agent_proto_goTypes = []any{
	...
	(*InlineImage)(nil),                        // 6: agent.InlineImage
	(*UpdateConfigRequest)(nil),                // 7: agent.UpdateConfigRequest
	(*UpdateConfigResponse)(nil),               // 8: agent.UpdateConfigResponse
	(*ProcessRequestResponse)(nil),             // 9: agent.ProcessRequestResponse
	(*FileChange)(nil),                         // 10: agent.FileChange
	(*RoutingMetadata)(nil),                    // 11: agent.RoutingMetadata
	(*ListModelsRequest)(nil),                  // 12: agent.ListModelsRequest
	(*ModelInfo)(nil),                          // 13: agent.ModelInfo
	(*ListModelsResponse)(nil),                 // 14: agent.ListModelsResponse
	(*RuntimeModel)(nil),                       // 15: agent.RuntimeModel
	(*RuntimeInstance)(nil),                    // 16: agent.RuntimeInstance
	(*RuntimeEndpoint)(nil),                    // 17: agent.RuntimeEndpoint
	(*RuntimeLogEntry)(nil),                    // 18: agent.RuntimeLogEntry
	(*GetRuntimeStatusRequest)(nil),            // 19: agent.GetRuntimeStatusRequest
	(*GetRuntimeStatusResponse)(nil),           // 20: agent.GetRuntimeStatusResponse
	(*ListRuntimeModelsRequest)(nil),           // 21: agent.ListRuntimeModelsRequest
	(*ListRuntimeModelsResponse)(nil),          // 22: agent.ListRuntimeModelsResponse
	(*ListRuntimeEndpointsRequest)(nil),        // 23: agent.ListRuntimeEndpointsRequest
	(*ListRuntimeEndpointsResponse)(nil),       // 24: agent.ListRuntimeEndpointsResponse
	(*StartRuntimeModelRequest)(nil),           // 25: agent.StartRuntimeModelRequest
	(*StartRuntimeModelResponse)(nil),          // 26: agent.StartRuntimeModelResponse
	(*StopRuntimeModelRequest)(nil),            // 27: agent.StopRuntimeModelRequest
	(*StopRuntimeModelResponse)(nil),           // 28: agent.StopRuntimeModelResponse
	(*RestartRuntimeRequest)(nil),              // 29: agent.RestartRuntimeRequest
	(*RestartRuntimeResponse)(nil),             // 30: agent.RestartRuntimeResponse
	(*DownloadRuntimeModelRequest)(nil),        // 31: agent.DownloadRuntimeModelRequest
	(*DownloadRuntimeModelResponse)(nil),       // 32: agent.DownloadRuntimeModelResponse
	(*CancelRuntimeModelDownloadRequest)(nil),  // 33: agent.CancelRuntimeModelDownloadRequest
	(*CancelRuntimeModelDownloadResponse)(nil), // 34: agent.CancelRuntimeModelDownloadResponse
	(*DeleteRuntimeModelRequest)(nil),          // 35: agent.DeleteRuntimeModelRequest
	(*DeleteRuntimeModelResponse)(nil),         // 36: agent.DeleteRuntimeModelResponse
	(*StreamRuntimeLogsRequest)(nil),           // 37: agent.StreamRuntimeLogsRequest
	(*Conversation)(nil),                       // 38: agent.Conversation
	(*PersistedTurn)(nil),                      // 39: agent.PersistedTurn
	(*ListConversationsRequest)(nil),           // 40: agent.ListConversationsRequest
	(*ListConversationsResponse)(nil),          // 41: agent.ListConversationsResponse
	(*ResumeConversationRequest)(nil),          // 42: agent.ResumeConversationRequest
	(*ResumeConversationResponse)(nil),         // 43: agent.ResumeConversationResponse
	(*DeleteConversationRequest)(nil),          // 44: agent.DeleteConversationRequest
	(*DeleteConversationResponse)(nil),         // 45: agent.DeleteConversationResponse
	(*RenameConversationRequest)(nil),          // 46: agent.RenameConversationRequest
	(*RenameConversationResponse)(nil),         // 47: agent.RenameConversationResponse
	(*GetConversationRequest)(nil),             // 48: agent.GetConversationRequest
	(*GetContextUsageRequest)(nil),             // 49: agent.GetContextUsageRequest
	(*GetContextUsageResponse)(nil),            // 50: agent.GetContextUsageResponse
	(*SuggestNextPromptRequest)(nil),           // 51: agent.SuggestNextPromptRequest
	(*SuggestNextPromptResponse)(nil),          // 52: agent.SuggestNextPromptResponse
	(*GetCompactionStateRequest)(nil),          // 53: agent.GetCompactionStateRequest
	(*GetCompactionStateResponse)(nil),         // 54: agent.GetCompactionStateResponse
	(*ExportContextRequest)(nil),               // 55: agent.ExportContextRequest
	(*ExportContextResponse)(nil),              // 56: agent.ExportContextResponse
	(*GetConversationTurnsRequest)(nil),        // 57: agent.GetConversationTurnsRequest
	(*GetConversationTurnsResponse)(nil),       // 58: agent.GetConversationTurnsResponse
	(*ContextTurn)(nil),                        // 59: agent.ContextTurn
	(*ProposeContextEditRequest)(nil),          // 60: agent.ProposeContextEditRequest
	(*ProposeContextEditResponse)(nil),         // 61: agent.ProposeContextEditResponse
	(*DeleteConversationTurnsRequest)(nil),     // 62: agent.DeleteConversationTurnsRequest
	(*DeleteConversationTurnsResponse)(nil),    // 63: agent.DeleteConversationTurnsResponse
	(*BuiltinTool)(nil),                        // 64: agent.BuiltinTool
	(*ListToolsRequest)(nil),                   // 65: agent.ListToolsRequest
	(*ListToolsResponse)(nil),                  // 66: agent.ListToolsResponse
	(*InvokeToolRequest)(nil),                  // 67: agent.InvokeToolRequest
	(*InvokeToolResponse)(nil),                 // 68: agent.InvokeToolResponse
	(*InvokeCapabilityRequest)(nil),            // 69: agent.InvokeCapabilityRequest
	(*InvokeCapabilityResponse)(nil),           // 70: agent.InvokeCapabilityResponse
	(*GetConfigRequest)(nil),                   // 71: agent.GetConfigRequest
	(*GetConfigResponse)(nil),                  // 72: agent.GetConfigResponse
	(*ListSkillsRequest)(nil),                  // 73: agent.ListSkillsRequest
	(*SkillInfo)(nil),                          // 74: agent.SkillInfo
	(*ListSkillsResponse)(nil),                 // 75: agent.ListSkillsResponse
	(*GetSkillRequest)(nil),                    // 76: agent.GetSkillRequest
	(*GetSkillResponse)(nil),                   // 77: agent.GetSkillResponse
	(*SetPermissionModeRequest)(nil),           // 78: agent.SetPermissionModeRequest
	(*SetPermissionModeResponse)(nil),          // 79: agent.SetPermissionModeResponse
	(*GetPermissionModeRequest)(nil),           // 80: agent.GetPermissionModeRequest
	(*GetPermissionModeResponse)(nil),          // 81: agent.GetPermissionModeResponse
	(*SubscribeEventsRequest)(nil),             // 82: agent.SubscribeEventsRequest
	(*ClientEvent)(nil),                        // 83: agent.ClientEvent
	(*PermissionModeChanged)(nil),              // 84: agent.PermissionModeChanged
	(*ConfigChanged)(nil),                      // 85: agent.ConfigChanged
	(*MeridianStatus)(nil),                     // 86: agent.MeridianStatus
	(*MeridianStatusChanged)(nil),              // 87: agent.MeridianStatusChanged
	(*AllowToolCallRequest)(nil),               // 88: agent.AllowToolCallRequest
	(*AllowToolCallResponse)(nil),              // 89: agent.AllowToolCallResponse
	(*DenyToolCallRequest)(nil),                // 90: agent.DenyToolCallRequest
	(*DenyToolCallResponse)(nil),               // 91: agent.DenyToolCallResponse
	(*GetProviderCapabilitiesRequest)(nil),     // 92: agent.GetProviderCapabilitiesRequest
	(*GetProviderCapabilitiesResponse)(nil),    // 93: agent.GetProviderCapabilitiesResponse
	(*ToolUseStart)(nil),                       // 94: agent.ToolUseStart
	(*ToolUseStop)(nil),                        // 95: agent.ToolUseStop
	(*ToolExecStart)(nil),                      // 96: agent.ToolExecStart
	(*ToolExecComplete)(nil),                   // 97: agent.ToolExecComplete
	(*PermissionRequired)(nil),                 // 98: agent.PermissionRequired
	(*McpServerInfo)(nil),                      // 99: agent.McpServerInfo
	(*ListMcpServersRequest)(nil),              // 100: agent.ListMcpServersRequest
	(*ListMcpServersResponse)(nil),             // 101: agent.ListMcpServersResponse
	(*AddMcpServerRequest)(nil),                // 102: agent.AddMcpServerRequest
	(*AddMcpServerResponse)(nil),               // 103: agent.AddMcpServerResponse
	(*RemoveMcpServerRequest)(nil),             // 104: agent.RemoveMcpServerRequest
	(*RemoveMcpServerResponse)(nil),            // 105: agent.RemoveMcpServerResponse
	(*RestartMcpServerRequest)(nil),            // 106: agent.RestartMcpServerRequest
	(*RestartMcpServerResponse)(nil),           // 107: agent.RestartMcpServerResponse
	(*CloudProfileInfo)(nil),                   // 108: agent.CloudProfileInfo
	(*GetCloudProfilesRequest)(nil),            // 109: agent.GetCloudProfilesRequest
	(*GetCloudProfilesResponse)(nil),           // 110: agent.GetCloudProfilesResponse
	(*SetActiveCloudProfileRequest)(nil),       // 111: agent.SetActiveCloudProfileRequest
	(*SetActiveCloudProfileResponse)(nil),      // 112: agent.SetActiveCloudProfileResponse
	(*SetCloudProfileKeyRequest)(nil),          // 113: agent.SetCloudProfileKeyRequest
	(*SetCloudProfileKeyResponse)(nil),         // 114: agent.SetCloudProfileKeyResponse
	(*UpsertCloudProfileRequest)(nil),          // 115: agent.UpsertCloudProfileRequest
	(*UpsertCloudProfileResponse)(nil),         // 116: agent.UpsertCloudProfileResponse
	(*RemoveCloudProfileRequest)(nil),          // 117: agent.RemoveCloudProfileRequest
	(*RemoveCloudProfileResponse)(nil),         // 118: agent.RemoveCloudProfileResponse
	nil,                                        // 119: agent.AddMcpServerRequest.EnvEntry
}
var file_agent_proto_depIdxs = []int32{
	4,   // 0: agent.StreamProcessResponse.progress:type_name -> agent.ProgressUpdate
	9,   // 1: agent.StreamProcessResponse.final_response:type_name -> agent.ProcessRequestResponse
	1,   // 2: agent.StreamProcessResponse.token_delta:type_name -> agent.TokenDelta
	94,  // 3: agent.StreamProcessResponse.tool_use_start:type_name -> agent.ToolUseStart
	95,  // 4: agent.StreamProcessResponse.tool_use_stop:type_name -> agent.ToolUseStop
	96,  // 5: agent.StreamProcessResponse.tool_exec_start:type_name -> agent.ToolExecStart
	97,  // 6: agent.StreamProcessResponse.tool_exec_complete:type_name -> agent.ToolExecComplete
	98,  // 7: agent.StreamProcessResponse.permission_required:type_name -> agent.PermissionRequired
	3,   // 8: agent.StreamProcessResponse.route_selected:type_name -> agent.RouteSelected
	6,   // 9: agent.ProcessRequestRequest.images:type_name -> agent.InlineImage
	10,  // 10: agent.ProcessRequestResponse.file_changes:type_name -> agent.FileChange
	11,  // 11: agent.ProcessRequestResponse.routing_metadata:type_name -> agent.RoutingMetadata
	0,   // 12: agent.FileChange.action:type_name -> agent.FileAction
	13,  // 13: agent.ListModelsResponse.models:type_name -> agent.ModelInfo
	15,  // 14: agent.GetRuntimeStatusResponse.models:type_name -> agent.RuntimeModel
	16,  // 15: agent.GetRuntimeStatusResponse.instances:type_name -> agent.RuntimeInstance
	17,  // 16: agent.GetRuntimeStatusResponse.endpoints:type_name -> agent.RuntimeEndpoint
	18,  // 17: agent.GetRuntimeStatusResponse.logs:type_name -> agent.RuntimeLogEntry
	15,  // 18: agent.ListRuntimeModelsResponse.models:type_name -> agent.RuntimeModel
	17,  // 19: agent.ListRuntimeEndpointsResponse.endpoints:type_name -> agent.RuntimeEndpoint
	16,  // 20: agent.StartRuntimeModelResponse.instance:type_name -> agent.RuntimeInstance
	16,  // 21: agent.RestartRuntimeResponse.instance:type_name -> agent.RuntimeInstance
	15,  // 22: agent.DownloadRuntimeModelResponse.model:type_name -> agent.RuntimeModel
	15,  // 23: agent.CancelRuntimeModelDownloadResponse.model:type_name -> agent.RuntimeModel
	38,  // 24: agent.ListConversationsResponse.conversations:type_name -> agent.Conversation
	39,  // 25: agent.ResumeConversationResponse.turns:type_name -> agent.PersistedTurn
	59,  // 26: agent.GetConversationTurnsResponse.turns:type_name -> agent.ContextTurn
	64,  // 27: agent.ListToolsResponse.tools:type_name -> agent.BuiltinTool
	74,  // 28: agent.ListSkillsResponse.skills:type_name -> agent.SkillInfo
	84,  // 29: agent.ClientEvent.permission_mode_changed:type_name -> agent.PermissionModeChanged
	85,  // 30: agent.ClientEvent.config_changed:type_name -> agent.ConfigChanged
	87,  // 31: agent.ClientEvent.meridian_status_changed:type_name -> agent.MeridianStatusChanged
	86,  // 32: agent.MeridianStatusChanged.status:type_name -> agent.MeridianStatus
	99,  // 33: agent.ListMcpServersResponse.servers:type_name -> agent.McpServerInfo
	119, // 34: agent.AddMcpServerRequest.env:type_name -> agent.AddMcpServerRequest.EnvEntry
	108, // 35: agent.GetCloudProfilesResponse.profiles:type_name -> agent.CloudProfileInfo
	86,  // 36: agent.GetCloudProfilesResponse.meridian_status:type_name -> agent.MeridianStatus
	5,   // 37: agent.Agent.ProcessRequest:input_type -> agent.ProcessRequestRequest
	5,   // 38: agent.Agent.StreamProcessRequest:input_type -> agent.ProcessRequestRequest
	7,   // 39: agent.Agent.UpdateConfig:input_type -> agent.UpdateConfigRequest
	71,  // 40: agent.Agent.GetConfig:input_type -> agent.GetConfigRequest
	40,  // 41: agent.Agent.ListConversations:input_type -> agent.ListConversationsRequest
	42,  // 42: agent.Agent.ResumeConversation:input_type -> agent.ResumeConversationRequest
	44,  // 43: agent.Agent.DeleteConversation:input_type -> agent.DeleteConversationRequest
	46,  // 44: agent.Agent.RenameConversation:input_type -> agent.RenameConversationRequest
	48,  // 45: agent.Agent.GetConversation:input_type -> agent.GetConversationRequest
	49,  // 46: agent.Agent.GetContextUsage:input_type -> agent.GetContextUsageRequest
	53,  // 47: agent.Agent.GetCompactionState:input_type -> agent.GetCompactionStateRequest
	51,  // 48: agent.Agent.SuggestNextPrompt:input_type -> agent.SuggestNextPromptRequest
	55,  // 49: agent.Agent.ExportContext:input_type -> agent.ExportContextRequest
	57,  // 50: agent.Agent.GetConversationTurns:input_type -> agent.GetConversationTurnsRequest
	65,  // 51: agent.Agent.ListTools:input_type -> agent.ListToolsRequest
	67,  // 52: agent.Agent.InvokeTool:input_type -> agent.InvokeToolRequest
	69,  // 53: agent.Agent.InvokeCapability:input_type -> agent.InvokeCapabilityRequest
	12,  // 54: agent.Agent.ListModels:input_type -> agent.ListModelsRequest
	19,  // 55: agent.Agent.GetRuntimeStatus:input_type -> agent.GetRuntimeStatusRequest
	21,  // 56: agent.Agent.ListRuntimeModels:input_type -> agent.ListRuntimeModelsRequest
	23,  // 57: agent.Agent.ListRuntimeEndpoints:input_type -> agent.ListRuntimeEndpointsRequest
	25,  // 58: agent.Agent.StartRuntimeModel:input_type -> agent.StartRuntimeModelRequest
	27,  // 59: agent.Agent.StopRuntimeModel:input_type -> agent.StopRuntimeModelRequest
	29,  // 60: agent.Agent.RestartRuntime:input_type -> agent.RestartRuntimeRequest
	31,  // 61: agent.Agent.DownloadRuntimeModel:input_type -> agent.DownloadRuntimeModelRequest
	33,  // 62: agent.Agent.CancelRuntimeModelDownload:input_type -> agent.CancelRuntimeModelDownloadRequest
	35,  // 63: agent.Agent.DeleteRuntimeModel:input_type -> agent.DeleteRuntimeModelRequest
	37,  // 64: agent.Agent.StreamRuntimeLogs:input_type -> agent.StreamRuntimeLogsRequest
	73,  // 65: agent.Agent.ListSkills:input_type -> agent.ListSkillsRequest
	76,  // 66: agent.Agent.GetSkill:input_type -> agent.GetSkillRequest
	78,  // 67: agent.Agent.SetPermissionMode:input_type -> agent.SetPermissionModeRequest
	80,  // 68: agent.Agent.GetPermissionMode:input_type -> agent.GetPermissionModeRequest
	82,  // 69: agent.Agent.SubscribeEvents:input_type -> agent.SubscribeEventsRequest
	88,  // 70: agent.Agent.AllowToolCall:input_type -> agent.AllowToolCallRequest
	90,  // 71: agent.Agent.DenyToolCall:input_type -> agent.DenyToolCallRequest
	92,  // 72: agent.Agent.GetProviderCapabilities:input_type -> agent.GetProviderCapabilitiesRequest
	60,  // 73: agent.Agent.ProposeContextEdit:input_type -> agent.ProposeContextEditRequest
	62,  // 74: agent.Agent.DeleteConversationTurns:input_type -> agent.DeleteConversationTurnsRequest
	100, // 75: agent.Agent.ListMcpServers:input_type -> agent.ListMcpServersRequest
	102, // 76: agent.Agent.AddMcpServer:input_type -> agent.AddMcpServerRequest
	104, // 77: agent.Agent.RemoveMcpServer:input_type -> agent.RemoveMcpServerRequest
	106, // 78: agent.Agent.RestartMcpServer:input_type -> agent.RestartMcpServerRequest
	109, // 79: agent.Agent.GetCloudProfiles:input_type -> agent.GetCloudProfilesRequest
	111, // 80: agent.Agent.SetActiveCloudProfile:input_type -> agent.SetActiveCloudProfileRequest
	113, // 81: agent.Agent.SetCloudProfileKey:input_type -> agent.SetCloudProfileKeyRequest
	115, // 82: agent.Agent.UpsertCloudProfile:input_type -> agent.UpsertCloudProfileRequest
	117, // 83: agent.Agent.RemoveCloudProfile:input_type -> agent.RemoveCloudProfileRequest
	9,   // 84: agent.Agent.ProcessRequest:output_type -> agent.ProcessRequestResponse
	2,   // 85: agent.Agent.StreamProcessRequest:output_type -> agent.StreamProcessResponse
	8,   // 86: agent.Agent.UpdateConfig:output_type -> agent.UpdateConfigResponse
	72,  // 87: agent.Agent.GetConfig:output_type -> agent.GetConfigResponse
	41,  // 88: agent.Agent.ListConversations:output_type -> agent.ListConversationsResponse
	43,  // 89: agent.Agent.ResumeConversation:output_type -> agent.ResumeConversationResponse
	45,  // 90: agent.Agent.DeleteConversation:output_type -> agent.DeleteConversationResponse
	47,  // 91: agent.Agent.RenameConversation:output_type -> agent.RenameConversationResponse
	38,  // 92: agent.Agent.GetConversation:output_type -> agent.Conversation
	50,  // 93: agent.Agent.GetContextUsage:output_type -> agent.GetContextUsageResponse
	54,  // 94: agent.Agent.GetCompactionState:output_type -> agent.GetCompactionStateResponse
	52,  // 95: agent.Agent.SuggestNextPrompt:output_type -> agent.SuggestNextPromptResponse
	56,  // 96: agent.Agent.ExportContext:output_type -> agent.ExportContextResponse
	58,  // 97: agent.Agent.GetConversationTurns:output_type -> agent.GetConversationTurnsResponse
	66,  // 98: agent.Agent.ListTools:output_type -> agent.ListToolsResponse
	68,  // 99: agent.Agent.InvokeTool:output_type -> agent.InvokeToolResponse
	70,  // 100: agent.Agent.InvokeCapability:output_type -> agent.InvokeCapabilityResponse
	14,  // 101: agent.Agent.ListModels:output_type -> agent.ListModelsResponse
	20,  // 102: agent.Agent.GetRuntimeStatus:output_type -> agent.GetRuntimeStatusResponse
	22,  // 103: agent.Agent.ListRuntimeModels:output_type -> agent.ListRuntimeModelsResponse
	24,  // 104: agent.Agent.ListRuntimeEndpoints:output_type -> agent.ListRuntimeEndpointsResponse
	26,  // 105: agent.Agent.StartRuntimeModel:output_type -> agent.StartRuntimeModelResponse
	28,  // 106: agent.Agent.StopRuntimeModel:output_type -> agent.StopRuntimeModelResponse
	30,  // 107: agent.Agent.RestartRuntime:output_type -> agent.RestartRuntimeResponse
	32,  // 108: agent.Agent.DownloadRuntimeModel:output_type -> agent.DownloadRuntimeModelResponse
	34,  // 109: agent.Agent.CancelRuntimeModelDownload:output_type -> agent.CancelRuntimeModelDownloadResponse
	36,  // 110: agent.Agent.DeleteRuntimeModel:output_type -> agent.DeleteRuntimeModelResponse
	18,  // 111: agent.Agent.StreamRuntimeLogs:output_type -> agent.RuntimeLogEntry
	75,  // 112: agent.Agent.ListSkills:output_type -> agent.ListSkillsResponse
	77,  // 113: agent.Agent.GetSkill:output_type -> agent.GetSkillResponse
	79,  // 114: agent.Agent.SetPermissionMode:output_type -> agent.SetPermissionModeResponse
	81,  // 115: agent.Agent.GetPermissionMode:output_type -> agent.GetPermissionModeResponse
	83,  // 116: agent.Agent.SubscribeEvents:output_type -> agent.ClientEvent
	89,  // 117: agent.Agent.AllowToolCall:output_type -> agent.AllowToolCallResponse
	91,  // 118: agent.Agent.DenyToolCall:output_type -> agent.DenyToolCallResponse
	93,  // 119: agent.Agent.GetProviderCapabilities:output_type -> agent.GetProviderCapabilitiesResponse
	61,  // 120: agent.Agent.ProposeContextEdit:output_type -> agent.ProposeContextEditResponse
	63,  // 121: agent.Agent.DeleteConversationTurns:output_type -> agent.DeleteConversationTurnsResponse
	101, // 122: agent.Agent.ListMcpServers:output_type -> agent.ListMcpServersResponse
	103, // 123: agent.Agent.AddMcpServer:output_type -> agent.AddMcpServerResponse
	105, // 124: agent.Agent.RemoveMcpServer:output_type -> agent.RemoveMcpServerResponse
	107, // 125: agent.Agent.RestartMcpServer:output_type -> agent.RestartMcpServerResponse
	110, // 126: agent.Agent.GetCloudProfiles:output_type -> agent.GetCloudProfilesResponse
	112, // 127: agent.Agent.SetActiveCloudProfile:output_type -> agent.SetActiveCloudProfileResponse
	114, // 128: agent.Agent.SetCloudProfileKey:output_type -> agent.SetCloudProfileKeyResponse
	116, // 129: agent.Agent.UpsertCloudProfile:output_type -> agent.UpsertCloudProfileResponse
	118, // 130: agent.Agent.RemoveCloudProfile:output_type -> agent.RemoveCloudProfileResponse
