...
var file_agent_proto_goTypes = []any{
	...
	(*ConfigChanged)(nil),                      // 82: agent.ConfigChanged
	(*AllowToolCallRequest)(nil),               // 83: agent.AllowToolCallRequest
	(*AllowToolCallResponse)(nil),              // 84: agent.AllowToolCallResponse
	(*DenyToolCallRequest)(nil),                // 85: agent.DenyToolCallRequest
	(*DenyToolCallResponse)(nil),               // 86: agent.DenyToolCallResponse
	(*GetProviderCapabilitiesRequest)(nil),     // 87: agent.GetProviderCapabilitiesRequest
	(*GetProviderCapabilitiesResponse)(nil),    // 88: agent.GetProviderCapabilitiesResponse
	(*ToolUseStart)(nil),                       // 89: agent.ToolUseStart
	(*ToolUseStop)(nil),                        // 90: agent.ToolUseStop
	(*ToolExecStart)(nil),                      // 91: agent.ToolExecStart
	(*ToolExecComplete)(nil),                   // 92: agent.ToolExecComplete
	(*PermissionRequired)(nil),                 // 93: agent.PermissionRequired
	(*McpServerInfo)(nil),                      // 94: agent.McpServerInfo
	(*ListMcpServersRequest)(nil),              // 95: agent.ListMcpServersRequest
	(*ListMcpServersResponse)(nil),             // 96: agent.ListMcpServersResponse
	(*AddMcpServerRequest)(nil),                // 97: agent.AddMcpServerRequest
	(*AddMcpServerResponse)(nil),               // 98: agent.AddMcpServerResponse
	(*RemoveMcpServerRequest)(nil),             // 99: agent.RemoveMcpServerRequest
	(*RemoveMcpServerResponse)(nil),            // 100: agent.RemoveMcpServerResponse
	(*RestartMcpServerRequest)(nil),            // 101: agent.RestartMcpServerRequest
	(*RestartMcpServerResponse)(nil),           // 102: agent.RestartMcpServerResponse
	(*CloudProfileInfo)(nil),                   // 103: agent.CloudProfileInfo
	(*GetCloudProfilesRequest)(nil),            // 104: agent.GetCloudProfilesRequest
	(*GetCloudProfilesResponse)(nil),           // 105: agent.GetCloudProfilesResponse
	(*SetActiveCloudProfileRequest)(nil),       // 106: agent.SetActiveCloudProfileRequest
	(*SetActiveCloudProfileResponse)(nil),      // 107: agent.SetActiveCloudProfileResponse
	(*SetCloudProfileKeyRequest)(nil),          // 108: agent.SetCloudProfileKeyRequest
	(*SetCloudProfileKeyResponse)(nil),         // 109: agent.SetCloudProfileKeyResponse
	(*UpsertCloudProfileRequest)(nil),          // 110: agent.UpsertCloudProfileRequest
	(*UpsertCloudProfileResponse)(nil),         // 111: agent.UpsertCloudProfileResponse
	(*RemoveCloudProfileRequest)(nil),          // 112: agent.RemoveCloudProfileRequest
	(*RemoveCloudProfileResponse)(nil),         // 113: agent.RemoveCloudProfileResponse
	nil,                                        // 114: agent.AddMcpServerRequest.EnvEntry
}
var file_agent_proto_depIdxs = []int32{
	...
	89,  // 3: agent.StreamProcessResponse.tool_use_start:type_name -> agent.ToolUseStart
	90,  // 4: agent.StreamProcessResponse.tool_use_stop:type_name -> agent.ToolUseStop
	91,  // 5: agent.StreamProcessResponse.tool_exec_start:type_name -> agent.ToolExecStart
	92,  // 6: agent.StreamProcessResponse.tool_exec_complete:type_name -> agent.ToolExecComplete
	93,  // 7: agent.StreamProcessResponse.permission_required:type_name -> agent.PermissionRequired
	...
	82,  // 29: agent.ClientEvent.config_changed:type_name -> agent.ConfigChanged
	94,  // 30: agent.ListMcpServersResponse.servers:type_name -> agent.McpServerInfo
	114, // 31: agent.AddMcpServerRequest.env:type_name -> agent.AddMcpServerRequest.EnvEntry
	103, // 32: agent.GetCloudProfilesResponse.profiles:type_name -> agent.CloudProfileInfo
	5,   // 33: agent.Agent.ProcessRequest:input_type -> agent.ProcessRequestRequest
	5,   // 34: agent.Agent.StreamProcessRequest:input_type -> agent.ProcessRequestRequest
	6,   // 35: agent.Agent.UpdateConfig:input_type -> agent.UpdateConfigRequest
	68,  // 36: agent.Agent.GetConfig:input_type -> agent.GetConfigRequest
	39,  // 37: agent.Agent.ListConversations:input_type -> agent.ListConversationsRequest
	41,  // 38: agent.Agent.ResumeConversation:input_type -> agent.ResumeConversationRequest
	43,  // 39: agent.Agent.DeleteConversation:input_type -> agent.DeleteConversationRequest
	45,  // 40: agent.Agent.RenameConversation:input_type -> agent.RenameConversationRequest
	47,  // 41: agent.Agent.GetConversation:input_type -> agent.GetConversationRequest
	48,  // 42: agent.Agent.GetContextUsage:input_type -> agent.GetContextUsageRequest
	50,  // 43: agent.Agent.GetCompactionState:input_type -> agent.GetCompactionStateRequest
	52,  // 44: agent.Agent.ExportContext:input_type -> agent.ExportContextRequest
	54,  // 45: agent.Agent.GetConversationTurns:input_type -> agent.GetConversationTurnsRequest
	62,  // 46: agent.Agent.ListTools:input_type -> agent.ListToolsRequest
	64,  // 47: agent.Agent.InvokeTool:input_type -> agent.InvokeToolRequest
	66,  // 48: agent.Agent.InvokeCapability:input_type -> agent.InvokeCapabilityRequest
	11,  // 49: agent.Agent.ListModels:input_type -> agent.ListModelsRequest
	18,  // 50: agent.Agent.GetRuntimeStatus:input_type -> agent.GetRuntimeStatusRequest
	20,  // 51: agent.Agent.ListRuntimeModels:input_type -> agent.ListRuntimeModelsRequest
	22,  // 52: agent.Agent.ListRuntimeEndpoints:input_type -> agent.ListRuntimeEndpointsRequest
	24,  // 53: agent.Agent.StartRuntimeModel:input_type -> agent.StartRuntimeModelRequest
	26,  // 54: agent.Agent.StopRuntimeModel:input_type -> agent.StopRuntimeModelRequest
	28,  // 55: agent.Agent.RestartRuntime:input_type -> agent.RestartRuntimeRequest
	30,  // 56: agent.Agent.DownloadRuntimeModel:input_type -> agent.DownloadRuntimeModelRequest
	32,  // 57: agent.Agent.CancelRuntimeModelDownload:input_type -> agent.CancelRuntimeModelDownloadRequest
	34,  // 58: agent.Agent.DeleteRuntimeModel:input_type -> agent.DeleteRuntimeModelRequest
	36,  // 59: agent.Agent.StreamRuntimeLogs:input_type -> agent.StreamRuntimeLogsRequest
	70,  // 60: agent.Agent.ListSkills:input_type -> agent.ListSkillsRequest
	73,  // 61: agent.Agent.GetSkill:input_type -> agent.GetSkillRequest
	75,  // 62: agent.Agent.SetPermissionMode:input_type -> agent.SetPermissionModeRequest
	77,  // 63: agent.Agent.GetPermissionMode:input_type -> agent.GetPermissionModeRequest
	79,  // 64: agent.Agent.SubscribeEvents:input_type -> agent.SubscribeEventsRequest
	83,  // 65: agent.Agent.AllowToolCall:input_type -> agent.AllowToolCallRequest
	85,  // 66: agent.Agent.DenyToolCall:input_type -> agent.DenyToolCallRequest
	87,  // 67: agent.Agent.GetProviderCapabilities:input_type -> agent.GetProviderCapabilitiesRequest
	57,  // 68: agent.Agent.ProposeContextEdit:input_type -> agent.ProposeContextEditRequest
	59,  // 69: agent.Agent.DeleteConversationTurns:input_type -> agent.DeleteConversationTurnsRequest
	95,  // 70: agent.Agent.ListMcpServers:input_type -> agent.ListMcpServersRequest
	97,  // 71: agent.Agent.AddMcpServer:input_type -> agent.AddMcpServerRequest
	99,  // 72: agent.Agent.RemoveMcpServer:input_type -> agent.RemoveMcpServerRequest
	101, // 73: agent.Agent.RestartMcpServer:input_type -> agent.RestartMcpServerRequest
	104, // 74: agent.Agent.GetCloudProfiles:input_type -> agent.GetCloudProfilesRequest
	106, // 75: agent.Agent.SetActiveCloudProfile:input_type -> agent.SetActiveCloudProfileRequest
	108, // 76: agent.Agent.SetCloudProfileKey:input_type -> agent.SetCloudProfileKeyRequest
	110, // 77: agent.Agent.UpsertCloudProfile:input_type -> agent.UpsertCloudProfileRequest
	112, // 78: agent.Agent.RemoveCloudProfile:input_type -> agent.RemoveCloudProfileRequest
	8,   // 79: agent.Agent.ProcessRequest:output_type -> agent.ProcessRequestResponse
	2,   // 80: agent.Agent.StreamProcessRequest:output_type -> agent.StreamProcessResponse
	7,   // 81: agent.Agent.UpdateConfig:output_type -> agent.UpdateConfigResponse
	69,  // 82: agent.Agent.GetConfig:output_type -> agent.GetConfigResponse
	40,  // 83: agent.Agent.ListConversations:output_type -> agent.ListConversationsResponse
	42,  // 84: agent.Agent.ResumeConversation:output_type -> agent.ResumeConversationResponse
	44,  // 85: agent.Agent.DeleteConversation:output_type -> agent.DeleteConversationResponse
	46,  // 86: agent.Agent.RenameConversation:output_type -> agent.RenameConversationResponse
	37,  // 87: agent.Agent.GetConversation:output_type -> agent.Conversation
	49,  // 88: agent.Agent.GetContextUsage:output_type -> agent.GetContextUsageResponse
	51,  // 89: agent.Agent.GetCompactionState:output_type -> agent.GetCompactionStateResponse
	53,  // 90: agent.Agent.ExportContext:output_type -> agent.ExportContextResponse
	55,  // 91: agent.Agent.GetConversationTurns:output_type -> agent.GetConversationTurnsResponse
	63,  // 92: agent.Agent.ListTools:output_type -> agent.ListToolsResponse
	65,  // 93: agent.Agent.InvokeTool:output_type -> agent.InvokeToolResponse
	67,  // 94: agent.Agent.InvokeCapability:output_type -> agent.InvokeCapabilityResponse
	13,  // 95: agent.Agent.ListModels:output_type -> agent.ListModelsResponse
	19,  // 96: agent.Agent.GetRuntimeStatus:output_type -> agent.GetRuntimeStatusResponse
	21,  // 97: agent.Agent.ListRuntimeModels:output_type -> agent.ListRuntimeModelsResponse
	23,  // 98: agent.Agent.ListRuntimeEndpoints:output_type -> agent.ListRuntimeEndpointsResponse
	25,  // 99: agent.Agent.StartRuntimeModel:output_type -> agent.StartRuntimeModelResponse
	27,  // 100: agent.Agent.StopRuntimeModel:output_type -> agent.StopRuntimeModelResponse
	29,  // 101: agent.Agent.RestartRuntime:output_type -> agent.RestartRuntimeResponse
	31,  // 102: agent.Agent.DownloadRuntimeModel:output_type -> agent.DownloadRuntimeModelResponse
	33,  // 103: agent.Agent.CancelRuntimeModelDownload:output_type -> agent.CancelRuntimeModelDownloadResponse
	35,  // 104: agent.Agent.DeleteRuntimeModel:output_type -> agent.DeleteRuntimeModelResponse
	17,  // 105: agent.Agent.StreamRuntimeLogs:output_type -> agent.RuntimeLogEntry
	72,  // 106: agent.Agent.ListSkills:output_type -> agent.ListSkillsResponse
	74,  // 107: agent.Agent.GetSkill:output_type -> agent.GetSkillResponse
	76,  // 108: agent.Agent.SetPermissionMode:output_type -> agent.SetPermissionModeResponse
	78,  // 109: agent.Agent.GetPermissionMode:output_type -> agent.GetPermissionModeResponse
	80,  // 110: agent.Agent.SubscribeEvents:output_type -> agent.ClientEvent
	84,  // 111: agent.Agent.AllowToolCall:output_type -> agent.AllowToolCallResponse
	86,  // 112: agent.Agent.DenyToolCall:output_type -> agent.DenyToolCallResponse
	88,  // 113: agent.Agent.GetProviderCapabilities:output_type -> agent.GetProviderCapabilitiesResponse
	58,  // 114: agent.Agent.ProposeContextEdit:output_type -> agent.ProposeContextEditResponse
	60,  // 115: agent.Agent.DeleteConversationTurns:output_type -> agent.DeleteConversationTurnsResponse
	96,  // 116: agent.Agent.ListMcpServers:output_type -> agent.ListMcpServersResponse
	98,  // 117: agent.Agent.AddMcpServer:output_type -> agent.AddMcpServerResponse
	100, // 118: agent.Agent.RemoveMcpServer:output_type -> agent.RemoveMcpServerResponse
	102, // 119: agent.Agent.RestartMcpServer:output_type -> agent.RestartMcpServerResponse
	105, // 120: agent.Agent.GetCloudProfiles:output_type -> agent.GetCloudProfilesResponse
	107, // 121: agent.Agent.SetActiveCloudProfile:output_type -> agent.SetActiveCloudProfileResponse
	109, // 122: agent.Agent.SetCloudProfileKey:output_type -> agent.SetCloudProfileKeyResponse
	111, // 123: agent.Agent.UpsertCloudProfile:output_type -> agent.UpsertCloudProfileResponse
	113, // 124: agent.Agent.RemoveCloudProfile:output_type -> agent.RemoveCloudProfileResponse
