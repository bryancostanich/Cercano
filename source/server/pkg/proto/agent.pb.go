...
const file_agent_proto_rawDesc = "" +
	...
	"\x11SuggestNextPrompt\x12\x1f.agent.SuggestNextPromptRequest\x1a .agent.SuggestNextPromptResponse\"\x00\x12T\n" +
...
var file_agent_proto_msgTypes = make([]protoimpl.MessageInfo, 124)
var file_agent_proto_goTypes = []any{
	...
	(*InstallLocalRuntimeRequest)(nil),         // 91: agent.InstallLocalRuntimeRequest
	(*InstallProgress)(nil),                    // 92: agent.InstallProgress
	(*AllowToolCallRequest)(nil),               // 93: agent.AllowToolCallRequest
	(*AllowToolCallResponse)(nil),              // 94: agent.AllowToolCallResponse
	(*DenyToolCallRequest)(nil),                // 95: agent.DenyToolCallRequest
	(*DenyToolCallResponse)(nil),               // 96: agent.DenyToolCallResponse
	(*GetProviderCapabilitiesRequest)(nil),     // 97: agent.GetProviderCapabilitiesRequest
	(*GetProviderCapabilitiesResponse)(nil),    // 98: agent.GetProviderCapabilitiesResponse
	(*ToolUseStart)(nil),                       // 99: agent.ToolUseStart
	(*ToolUseStop)(nil),                        // 100: agent.ToolUseStop
	(*ToolExecStart)(nil),                      // 101: agent.ToolExecStart
	(*ToolExecComplete)(nil),                   // 102: agent.ToolExecComplete
	(*PermissionRequired)(nil),                 // 103: agent.PermissionRequired
	(*McpServerInfo)(nil),                      // 104: agent.McpServerInfo
	(*ListMcpServersRequest)(nil),              // 105: agent.ListMcpServersRequest
	(*ListMcpServersResponse)(nil),             // 106: agent.ListMcpServersResponse
	(*AddMcpServerRequest)(nil),                // 107: agent.AddMcpServerRequest
	(*AddMcpServerResponse)(nil),               // 108: agent.AddMcpServerResponse
	(*RemoveMcpServerRequest)(nil),             // 109: agent.RemoveMcpServerRequest
	(*RemoveMcpServerResponse)(nil),            // 110: agent.RemoveMcpServerResponse
	(*RestartMcpServerRequest)(nil),            // 111: agent.RestartMcpServerRequest
	(*RestartMcpServerResponse)(nil),           // 112: agent.RestartMcpServerResponse
	(*CloudProfileInfo)(nil),                   // 113: agent.CloudProfileInfo
	(*GetCloudProfilesRequest)(nil),            // 114: agent.GetCloudProfilesRequest
	(*GetCloudProfilesResponse)(nil),           // 115: agent.GetCloudProfilesResponse
	(*SetActiveCloudProfileRequest)(nil),       // 116: agent.SetActiveCloudProfileRequest
	(*SetActiveCloudProfileResponse)(nil),      // 117: agent.SetActiveCloudProfileResponse
	(*SetCloudProfileKeyRequest)(nil),          // 118: agent.SetCloudProfileKeyRequest
	(*SetCloudProfileKeyResponse)(nil),         // 119: agent.SetCloudProfileKeyResponse
	(*UpsertCloudProfileRequest)(nil),          // 120: agent.UpsertCloudProfileRequest
	(*UpsertCloudProfileResponse)(nil),         // 121: agent.UpsertCloudProfileResponse
	(*RemoveCloudProfileRequest)(nil),          // 122: agent.RemoveCloudProfileRequest
	(*RemoveCloudProfileResponse)(nil),         // 123: agent.RemoveCloudProfileResponse
	nil,                                        // 124: agent.AddMcpServerRequest.EnvEntry
}
var file_agent_proto_depIdxs = []int32{
	...
	99,  // 3: agent.StreamProcessResponse.tool_use_start:type_name -> agent.ToolUseStart
	100, // 4: agent.StreamProcessResponse.tool_use_stop:type_name -> agent.ToolUseStop
	101, // 5: agent.StreamProcessResponse.tool_exec_start:type_name -> agent.ToolExecStart
	102, // 6: agent.StreamProcessResponse.tool_exec_complete:type_name -> agent.ToolExecComplete
	103, // 7: agent.StreamProcessResponse.permission_required:type_name -> agent.PermissionRequired
	...
	104, // 36: agent.ListMcpServersResponse.servers:type_name -> agent.McpServerInfo
	124, // 37: agent.AddMcpServerRequest.env:type_name -> agent.AddMcpServerRequest.EnvEntry
	113, // 38: agent.GetCloudProfilesResponse.profiles:type_name -> agent.CloudProfileInfo
	...
	91,  // 52: agent.Agent.InstallLocalRuntime:input_type -> agent.InstallLocalRuntimeRequest
	56,  // 53: agent.Agent.ExportContext:input_type -> agent.ExportContextRequest
	58,  // 54: agent.Agent.GetConversationTurns:input_type -> agent.GetConversationTurnsRequest
	66,  // 55: agent.Agent.ListTools:input_type -> agent.ListToolsRequest
	68,  // 56: agent.Agent.InvokeTool:input_type -> agent.InvokeToolRequest
	70,  // 57: agent.Agent.InvokeCapability:input_type -> agent.InvokeCapabilityRequest
	13,  // 58: agent.Agent.ListModels:input_type -> agent.ListModelsRequest
	20,  // 59: agent.Agent.GetRuntimeStatus:input_type -> agent.GetRuntimeStatusRequest
	22,  // 60: agent.Agent.ListRuntimeModels:input_type -> agent.ListRuntimeModelsRequest
	24,  // 61: agent.Agent.ListRuntimeEndpoints:input_type -> agent.ListRuntimeEndpointsRequest
	26,  // 62: agent.Agent.StartRuntimeModel:input_type -> agent.StartRuntimeModelRequest
	28,  // 63: agent.Agent.StopRuntimeModel:input_type -> agent.StopRuntimeModelRequest
	30,  // 64: agent.Agent.RestartRuntime:input_type -> agent.RestartRuntimeRequest
	32,  // 65: agent.Agent.DownloadRuntimeModel:input_type -> agent.DownloadRuntimeModelRequest
	34,  // 66: agent.Agent.CancelRuntimeModelDownload:input_type -> agent.CancelRuntimeModelDownloadRequest
	36,  // 67: agent.Agent.DeleteRuntimeModel:input_type -> agent.DeleteRuntimeModelRequest
	38,  // 68: agent.Agent.StreamRuntimeLogs:input_type -> agent.StreamRuntimeLogsRequest
	74,  // 69: agent.Agent.ListSkills:input_type -> agent.ListSkillsRequest
	77,  // 70: agent.Agent.GetSkill:input_type -> agent.GetSkillRequest
	79,  // 71: agent.Agent.SetPermissionMode:input_type -> agent.SetPermissionModeRequest
	81,  // 72: agent.Agent.GetPermissionMode:input_type -> agent.GetPermissionModeRequest
	83,  // 73: agent.Agent.SubscribeEvents:input_type -> agent.SubscribeEventsRequest
	93,  // 74: agent.Agent.AllowToolCall:input_type -> agent.AllowToolCallRequest
	95,  // 75: agent.Agent.DenyToolCall:input_type -> agent.DenyToolCallRequest
	97,  // 76: agent.Agent.GetProviderCapabilities:input_type -> agent.GetProviderCapabilitiesRequest
	61,  // 77: agent.Agent.ProposeContextEdit:input_type -> agent.ProposeContextEditRequest
	63,  // 78: agent.Agent.DeleteConversationTurns:input_type -> agent.DeleteConversationTurnsRequest
	105, // 79: agent.Agent.ListMcpServers:input_type -> agent.ListMcpServersRequest
	107, // 80: agent.Agent.AddMcpServer:input_type -> agent.AddMcpServerRequest
	109, // 81: agent.Agent.RemoveMcpServer:input_type -> agent.RemoveMcpServerRequest
	111, // 82: agent.Agent.RestartMcpServer:input_type -> agent.RestartMcpServerRequest
	114, // 83: agent.Agent.GetCloudProfiles:input_type -> agent.GetCloudProfilesRequest
	116, // 84: agent.Agent.SetActiveCloudProfile:input_type -> agent.SetActiveCloudProfileRequest
	118, // 85: agent.Agent.SetCloudProfileKey:input_type -> agent.SetCloudProfileKeyRequest
	120, // 86: agent.Agent.UpsertCloudProfile:input_type -> agent.UpsertCloudProfileRequest
	122, // 87: agent.Agent.RemoveCloudProfile:input_type -> agent.RemoveCloudProfileRequest
	10,  // 88: agent.Agent.ProcessRequest:output_type -> agent.ProcessRequestResponse
	2,   // 89: agent.Agent.StreamProcessRequest:output_type -> agent.StreamProcessResponse
	9,   // 90: agent.Agent.UpdateConfig:output_type -> agent.UpdateConfigResponse
	73,  // 91: agent.Agent.GetConfig:output_type -> agent.GetConfigResponse
	42,  // 92: agent.Agent.ListConversations:output_type -> agent.ListConversationsResponse
	44,  // 93: agent.Agent.ResumeConversation:output_type -> agent.ResumeConversationResponse
	46,  // 94: agent.Agent.DeleteConversation:output_type -> agent.DeleteConversationResponse
	48,  // 95: agent.Agent.RenameConversation:output_type -> agent.RenameConversationResponse
	39,  // 96: agent.Agent.GetConversation:output_type -> agent.Conversation
	51,  // 97: agent.Agent.GetContextUsage:output_type -> agent.GetContextUsageResponse
	55,  // 98: agent.Agent.GetCompactionState:output_type -> agent.GetCompactionStateResponse
	53,  // 99: agent.Agent.SuggestNextPrompt:output_type -> agent.SuggestNextPromptResponse
	92,  // 100: agent.Agent.InstallLocalRuntime:output_type -> agent.InstallProgress
	57,  // 101: agent.Agent.ExportContext:output_type -> agent.ExportContextResponse
	59,  // 102: agent.Agent.GetConversationTurns:output_type -> agent.GetConversationTurnsResponse
	67,  // 103: agent.Agent.ListTools:output_type -> agent.ListToolsResponse
	69,  // 104: agent.Agent.InvokeTool:output_type -> agent.InvokeToolResponse
	71,  // 105: agent.Agent.InvokeCapability:output_type -> agent.InvokeCapabilityResponse
	15,  // 106: agent.Agent.ListModels:output_type -> agent.ListModelsResponse
	21,  // 107: agent.Agent.GetRuntimeStatus:output_type -> agent.GetRuntimeStatusResponse
	23,  // 108: agent.Agent.ListRuntimeModels:output_type -> agent.ListRuntimeModelsResponse
	25,  // 109: agent.Agent.ListRuntimeEndpoints:output_type -> agent.ListRuntimeEndpointsResponse
	27,  // 110: agent.Agent.StartRuntimeModel:output_type -> agent.StartRuntimeModelResponse
	29,  // 111: agent.Agent.StopRuntimeModel:output_type -> agent.StopRuntimeModelResponse
	31,  // 112: agent.Agent.RestartRuntime:output_type -> agent.RestartRuntimeResponse
	33,  // 113: agent.Agent.DownloadRuntimeModel:output_type -> agent.DownloadRuntimeModelResponse
	35,  // 114: agent.Agent.CancelRuntimeModelDownload:output_type -> agent.CancelRuntimeModelDownloadResponse
	37,  // 115: agent.Agent.DeleteRuntimeModel:output_type -> agent.DeleteRuntimeModelResponse
	19,  // 116: agent.Agent.StreamRuntimeLogs:output_type -> agent.RuntimeLogEntry
	76,  // 117: agent.Agent.ListSkills:output_type -> agent.ListSkillsResponse
	78,  // 118: agent.Agent.GetSkill:output_type -> agent.GetSkillResponse
	80,  // 119: agent.Agent.SetPermissionMode:output_type -> agent.SetPermissionModeResponse
	82,  // 120: agent.Agent.GetPermissionMode:output_type -> agent.GetPermissionModeResponse
	84,  // 121: agent.Agent.SubscribeEvents:output_type -> agent.ClientEvent
	94,  // 122: agent.Agent.AllowToolCall:output_type -> agent.AllowToolCallResponse
	96,  // 123: agent.Agent.DenyToolCall:output_type -> agent.DenyToolCallResponse
	98,  // 124: agent.Agent.GetProviderCapabilities:output_type -> agent.GetProviderCapabilitiesResponse
	62,  // 125: agent.Agent.ProposeContextEdit:output_type -> agent.ProposeContextEditResponse
	64,  // 126: agent.Agent.DeleteConversationTurns:output_type -> agent.DeleteConversationTurnsResponse
	106, // 127: agent.Agent.ListMcpServers:output_type -> agent.ListMcpServersResponse
	108, // 128: agent.Agent.AddMcpServer:output_type -> agent.AddMcpServerResponse
	110, // 129: agent.Agent.RemoveMcpServer:output_type -> agent.RemoveMcpServerResponse
	112, // 130: agent.Agent.RestartMcpServer:output_type -> agent.RestartMcpServerResponse
	115, // 131: agent.Agent.GetCloudProfiles:output_type -> agent.GetCloudProfilesResponse
	117, // 132: agent.Agent.SetActiveCloudProfile:output_type -> agent.SetActiveCloudProfileResponse
	119, // 133: agent.Agent.SetCloudProfileKey:output_type -> agent.SetCloudProfileKeyResponse
	121, // 134: agent.Agent.UpsertCloudProfile:output_type -> agent.UpsertCloudProfileResponse
	123, // 135: agent.Agent.RemoveCloudProfile:output_type -> agent.RemoveCloudProfileResponse
