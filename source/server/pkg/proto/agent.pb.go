...
const file_source_proto_agent_proto_rawDesc = "" +
	...
	"\x10recap_updated_at\x18\t \x01(\x03R\x0erecapUpdatedAt\"\xf0\x01\n" +
...
var file_source_proto_agent_proto_msgTypes = make([]protoimpl.MessageInfo, 37)
...
var file_source_proto_agent_proto_depIdxs = []int32{
	...
	26, // 9: agent.ListToolsResponse.tools:type_name -> agent.BuiltinTool
	34, // 10: agent.ListSkillsResponse.skills:type_name -> agent.SkillInfo
	...
	31, // 14: agent.Agent.GetConfig:input_type -> agent.GetConfigRequest
	...
	23, // 19: agent.Agent.GetConversation:input_type -> agent.GetConversationRequest
	24, // 20: agent.Agent.GetContextUsage:input_type -> agent.GetContextUsageRequest
	27, // 21: agent.Agent.ListTools:input_type -> agent.ListToolsRequest
	29, // 22: agent.Agent.InvokeTool:input_type -> agent.InvokeToolRequest
	10, // 23: agent.Agent.ListModels:input_type -> agent.ListModelsRequest
	33, // 24: agent.Agent.ListSkills:input_type -> agent.ListSkillsRequest
	36, // 25: agent.Agent.GetSkill:input_type -> agent.GetSkillRequest
	7,  // 26: agent.Agent.ProcessRequest:output_type -> agent.ProcessRequestResponse
	2,  // 27: agent.Agent.StreamProcessRequest:output_type -> agent.StreamProcessResponse
	6,  // 28: agent.Agent.UpdateConfig:output_type -> agent.UpdateConfigResponse
	32, // 29: agent.Agent.GetConfig:output_type -> agent.GetConfigResponse
	16, // 30: agent.Agent.ListConversations:output_type -> agent.ListConversationsResponse
	18, // 31: agent.Agent.ResumeConversation:output_type -> agent.ResumeConversationResponse
	20, // 32: agent.Agent.DeleteConversation:output_type -> agent.DeleteConversationResponse
	22, // 33: agent.Agent.RenameConversation:output_type -> agent.RenameConversationResponse
	13, // 34: agent.Agent.GetConversation:output_type -> agent.Conversation
	25, // 35: agent.Agent.GetContextUsage:output_type -> agent.GetContextUsageResponse
	28, // 36: agent.Agent.ListTools:output_type -> agent.ListToolsResponse
	30, // 37: agent.Agent.InvokeTool:output_type -> agent.InvokeToolResponse
	12, // 38: agent.Agent.ListModels:output_type -> agent.ListModelsResponse
	35, // 39: agent.Agent.ListSkills:output_type -> agent.ListSkillsResponse
	37, // 40: agent.Agent.GetSkill:output_type -> agent.GetSkillResponse
